...
!(function (e, t, o) {
                ...
                drop: function (o, n) {
                    ...
                    if (i) {
                        ...
                        (s.start = o),
                            ...
                            t.fullCalendar("renderEvent", s, !0),
    ...
    (function (e, t, o) {
        (t.FlotChart = function (t, o) {
            (this.element = e(t)),
                (this.url = o),
                (this.requestData = function (t, o, a) {
                    var n = this;
                    return (
                        (a = o && e.isFunction(o) ? o : a),
                        (o = o && "string" == typeof o ? o : "POST"),
                        (n.option = t),
                        e
                            .ajax({
                                url: n.url,
                ...
                (this.listen = function () {
                    ...
                    return (
                        t.on("panel-refresh", function (t, o) {
                ...
                !(function () {
                    ...
                    (function () {
                        ...
                        e(t).each(function () {
                            var t =
                                    e(this).data("source") ||
                                    e.error("Bar Stacked: No source defined."),
                    ...
                    (function () {
                        ...
                        e(t).each(function () {
                            var t =
                                    e(this).data("source") ||
                                    e.error("Area: No source defined."),
                                o = new FlotChart(this, t),
                                a = {
                                    series: {
                                        lines: {
                    ...
                    (function () {
                        ...
                        e(t).each(function () {
                            var t =
                                    e(this).data("source") ||
                                    e.error("Line: No source defined."),
                                o = new FlotChart(this, t),
                                a = {
                                    series: {
                                        lines: {
                    ...
                    (function () {
                        ...
                        e(t).each(function () {
                            var t =
                                    e(this).data("source") ||
                                    e.error("Donut: No source defined."),
                                o = new FlotChart(this, t),
                                a = {
                                    series: {
                                        pie: {
    ...
    (function (e, t, o) {
        var a = function (t, o) {
            ...
            n.data("markdownarea") ||
                ((this.element = n),
                (this.options = e.extend({}, a.defaults, o)),
        ...
        e.extend(a.prototype, {
            init: function () {
                var o = this,
                    n = a.template;
                (n = n.replace(/\{\:lblPreview\}/g, this.options.lblPreview)),
                    (n = n.replace(
                        /\{\:lblCodeview\}/g,
                        this.options.lblCodeview
                    )),
                    (this.markdownarea = e(n)),
                    (this.content = this.markdownarea.find(
                        ".uk-markdownarea-content"
                    )),
                    (this.toolbar = this.markdownarea.find(
                        ".uk-markdownarea-toolbar"
                    )),
                    (this.preview = this.markdownarea
                        .find(".uk-markdownarea-preview")
                        .children()
                        .eq(0)),
                    (this.code = this.markdownarea.find(
                    ...
                    this.editor.on(
                        ...
                        (function () {
                            var t = function () {
                                ...
                                (o.currentvalue = String(e)),
                                    o.element.trigger("markdownarea-before", [
                                        o,
                                    ]),
                                    o.applyPlugins(),
                                    o.marked(o.currentvalue, function (e, t) {
                                        if (e) throw e;
                                        o.preview.html(t),
                                            o.element
                                                .val(o.editor.getValue())
                                                .trigger(
                                                    "markdownarea-update",
                                                    [o]
                                                );
                ...
                var r = o.preview.parent(),
                    ...
                    s = this.code.find(".CodeMirror-scroll").on(
                        "scroll",
                        e.Utils.debounce(function () {
                ...
                this.markdownarea.on(
                    "click",
                    ".uk-markdown-button-markdown, .uk-markdown-button-preview",
                    function (t) {
                        t.preventDefault(),
                            "tab" == o.markdownarea.attr("data-mode") &&
                                (o.markdownarea
                                    .find(
                                        ".uk-markdown-button-markdown, .uk-markdown-button-preview"
                                    )
                                    ...
                                    function () {
                                        var n = o[t].cb({
                                            ...
                                            replace: function (e) {
                                                ...
                                                (end =
                                                    o + this.found[0].length),
                                                    this.area.editor.replaceRange(
                                                        e,
                                                        {
                                                            line: this.line,
                                                            ch: o,
            ...
            _buildtoolbar: function () {
                if (this.options.toolbar && this.options.toolbar.length) {
                    ...
                    this.options.toolbar.forEach(function (e) {
                        if (a.commands[e]) {
                            var n = a.commands[e].title
                                ? a.commands[e].title
                                : e;
                            o.push(
                                '<li><a data-markdownarea-cmd="' +
                                    e +
                                    '" title="' +
                                    n +
                                    '" data-toggle="tooltip">' +
                            ...
                            function () {
                                ...
                                !o ||
                                    ...
                                    (t.activetab &&
                                        "code" != t.activetab &&
                                        "fullscreen" != o) ||
                                    a.commands[o].action.apply(t, [t.editor]);
                            }
                        );
                }
            },
            fit: function () {
                ...
                "split" == e &&
                    this.markdownarea.width() < this.options.maxsplitsize &&
                    (e = "tab"),
                    "tab" == e &&
                        (this.activetab ||
                            ((this.activetab = "code"),
                            this.markdownarea.attr(
                                "data-active-tab",
                                this.activetab
                            )),
                        this.markdownarea
                    ...
                    this.editor.refresh(),
                    this.preview.parent().css("height", this.code.height()),
                    this.markdownarea.attr("data-mode", e);
            },
            ...
            getMode: function () {
                ...
                return this.editor.getTokenAt(e).state.base.htmlState
                    ? "html"
                    : "markdown";
            },
        }),
        ...
        return (
            (a.commands = {
                fullscreen: {
                    ...
                    action: function (a) {
                        a.markdownarea.markdownarea.toggleClass(
                            "uk-markdownarea-fullscreen"
                        ),
                            e("html").toggleClass("markdownarea-fullscreen"),
                            e("html, body").scrollTop(0);
                        var n = a.getWrapperElement();
                        if (
                            a.markdownarea.markdownarea.hasClass(
                                "uk-markdownarea-fullscreen"
                            )
                        )
                            (a.state.fullScreenRestore = {
                                ...
                                (n.style.width = ""),
                                (n.style.height =
                                    a.markdownarea.content.height() + "px"),
                        ...
                        a.refresh(),
                            a.markdownarea.preview
                                .parent()
                                .css("height", a.markdownarea.code.height());
                    },
                },
                bold: {
                    title: "Bold",
            ...
            e(function () {
                e("textarea[data-uk-markdownarea]").each(function () {
                    ...
                    o.data("markdownarea") ||
                        (t = new a(
                            o,
                            e.Utils.options(o.attr("data-uk-markdownarea"))
                        ));
                });
            }),
            a
    ...
    (function (e, t, o) {
        e(function () {
            ...
            e(o)
                .on("click", i.dismiss)
                .on("click", t + ", " + n + ", " + a, function (e) {
                    e.stopPropagation();
                })
                .on("click", a, i.dismiss)
                .on("click", t, i.toggle)
                .keyup(function (e) {
    ...
    (function (e, t, o) {
        var a = {},
            ...
            i = function (e, t) {
                if (e) for (var o in n) e === n[o].group && n[o].close(t);
                else for (var o in n) n[o].close(t);
            },
            s = function (t) {
                (this.options = e.extend({}, s.defaults, t)),
                    ...
                    (this.element = e(
                        [
                            '<div class="tradify-notify-message alert-dismissable">',
                    ...
                    this.options.status &&
                        (this.element.addClass(
                            "alert alert-" + this.options.status
                        ),
                        (this.currentstatus = this.options.status)),
                    (this.group = this.options.group),
                    (n[this.uuid] = this),
                    a[this.options.pos] ||
                        (a[this.options.pos] = e(
                            '<div class="tradify-notify tradify-notify-' +
                                this.options.pos +
                                '"></div>'
                        )
                            .appendTo("body")
            ...
            e.extend(s.prototype, {
                ...
                close: function (e) {
                    var t = this,
                        o = function () {
                            t.element.remove(),
                                a[t.options.pos].children().length ||
                                    a[t.options.pos].hide(),
                                delete n[t.uuid];
                        };
    ...
    (function (e, t, o) {
        ...
        e(a).on("change", function () {
            var t = e(this),
                ...
                n = t.parents("table");
            n.find(
                "tbody > tr > td:nth-child(" + o + ') input[type="checkbox"]'
            ).prop("checked", a[0].checked);
        });
    })(jQuery, window, document),
    (function (e, t, o) {
        function a(e) {
            for (var o = e.offsetTop, a = 40; e.offsetParent; )
                (e = e.offsetParent), (o += e.offsetTop);
            return o - a - t.pageYOffset;
        }

        function n(e) {
            for (var o = e.offsetLeft, a = e.offsetWidth; e.offsetParent; )
        ...
        e(function () {
            e('[data-toggle="tooltip"]').tooltip({
                ...
                placement: function (e, t) {
                    var o = "top";
                    return (
                        a(t) < 0 && (o = "bottom"), n(t) < 0 && (o = "right"), o
                    );
                },
            });
        });
        ...
        e(function () {
            var t = e("#progressbar"),
                ...
                a = {
                    ...
                    param: "upfile",
                    loadstart: function () {
                        o.css("width", "0%").text("0%"),
                            t.removeClass("hidden");
                    },
                    progress: function (e) {
                        (e = Math.ceil(e)),
                            o.css("width", e + "%").text(e + "%");
                    },
                    allcomplete: function (e) {
                        o.css("width", "100%").text("100%"),
                            setTimeout(function () {
                                t.addClass("hidden");
                            }, 250),
                            alert(e);
            ...
            new e.upload.select(e("#upload-select"), a),
                new e.upload.drop(e("#upload-drop"), a);
        });
    })(jQuery, window, document),
    (function (e, t, o) {
        function a(t, o) {
            ...
            if (((o = e.extend({}, a.defaults, o)), t.length)) {
                if ("*.*" !== o.allow)
                    for (var i, s = 0; (i = t[s]); s++)
                        if (!n(o.allow, i.name))
                            return void ("string" == typeof o.notallowed
                                ? alert(o.notallowed)
                                : o.notallowed(i, o));
                var l = o.complete;
                if (o.single) {
        ...
        var r = function (t, o) {
            ...
            i.data("uploadSelect") ||
                ((this.element = i.on("change", function () {
                ...
                (n
                    .on("drop", function (e) {
                        e.dataTransfer &&
                            ...
                            (e.stopPropagation(),
                            e.preventDefault(),
                            n.removeClass(o.dragoverClass),
                            a(e.dataTransfer.files, o));
                    })
                    ...
                    .on("dragover", function (e) {
                        e.stopPropagation(),
                            e.preventDefault(),
                            r || (n.addClass(o.dragoverClass), (r = !0));
                    })
        ...
        return (
            ...
            (a.defaults = {
                ...
                notallowed: function (e, t) {
                    alert(
                        "Only the following file types are allowed: " + t.allow
                    );
                },
            }),
            (e.xhrupload = a),
    ...
    (function (e, t, o) {
        ...
        e(o).on("click", a, function (t) {
            ...
            var o = e(this),
                ...
                n = o.find(".btn");
            n.html(a),
                e(".user-block .user-block-picture .user-block-status").html(a),
                o.hasClass("open") && n.dropdown("toggle");
        });
    })(jQuery, window, document),
    (function (e, t, o) {
        "use strict";
        ...
        (e.support.transition = (function () {
            ...
            (e.support.requestAnimationFrame =
            ...
            (e.Utils.removeCssRules = function (e) {
                ...
                e &&
                    setTimeout(function () {
                        try {
                            for (
                                c = document.styleSheets, n = 0, s = c.length;
                                s > n;
                                n++
                            ) {
                                for (
                                    ...
                                    a.cssRules[t].type === CSSRule.STYLE_RULE &&
                                        e.test(a.cssRules[t].selectorText) &&
                                        o.unshift(t);
                                for (i = 0, d = o.length; d > i; i++)
                                    a.deleteRule(o[i]);
                            }
                        } catch (u) {}
                    }, 0);
            ...
            (e.Utils.isInView = function (t, o) {
                ...
                return (
                    ...
                    d + a.height() >= i &&
                    d - o.topoffset <= i + n.height() &&
                    l + a.width() >= r &&
                    l - o.leftoffset <= r + n.width()
                        ? !0
                        : !1
                );
            }),
            ...
            e(function () {
                if (e.support.mutationobserver) {
                    var t = new e.support.mutationobserver(
                        e.Utils.debounce(function (t) {
