...
(function (T, L) {
    "object" === typeof module && module.exports
        ? (module.exports = T.document ? L(T) : L)
        : (T.Highcharts = L(T));
    ...
    (function (a) {
        ...
        a.Fx.prototype = {
            ...
            update: function () {
                ...
                if (this[m + "Setter"]) this[m + "Setter"]();
                    ...
                    a.attr
                        ? a.element && a.attr(m, l, null, !0)
                        : (a.style[m] = l + this.unit);
                w && w.call(a, l, this);
            },
            run: function (r, m, l) {
                var w = this,
            ...
            step: function (r) {
                ...
                p.attr && !p.element
                    ...
                    ? ((this.now = this.end),
                      ...
                      l && v && v.call(p),
                      (r = !1))
                    : ((this.pos = w.easing((m - this.startTime) / B)),
                      (this.now =
            ...
            initPath: function (r, m, l) {
                ...
                function v(a, c) {
                    for (var e = (g - a.length) / b; 0 < e && e--; )
                        (n = a.slice().splice(a.length / u - b, b * u)),
                            (n[0] = c[g - b - e * b]),
                            k && ((n[b - 6] = n[b - 2]), (n[b - 5] = n[b - 1])),
                            [].splice.apply(a, [a.length / u, 0].concat(n)),
                            f && e--;
                }
                m = m || "";
                var B,
        ...
        a.attr = function (r, m, l) {
            ...
            a.isString(m)
                ? a.defined(l)
                    ? r.setAttribute(m, l)
                    : r && r.getAttribute && (w = r.getAttribute(m))
                : a.defined(m) &&
                  a.isObject(m) &&
                  a.objectEach(m, function (a, l) {
                      r.setAttribute(l, a);
                  });
            return w;
        };
        ...
        a.pick = function () {
            var a = arguments,
                ...
                w = a.length;
            for (m = 0; m < w; m++)
                if (((l = a[m]), void 0 !== l && null !== l)) return l;
        };
        a.css = function (r, m) {
            a.isMS &&
                !a.svg &&
                m &&
                void 0 !== m.opacity &&
                (m.filter = "alpha(opacity\x3d" + 100 * m.opacity + ")");
            a.extend(r.style, m);
        };
                ...
                ? ((l = (l = r.match(w)) ? l[1] : -1),
                  null !== m &&
                      (m = a.numberFormat(
                          ...
                          l,
                          p.decimalPoint,
                          -1 < r.indexOf(",") ? p.thousandsSep : ""
                      )))
                : (m = (l || a.time).dateFormat(r, m));
            return m;
        };
        ...
        a.setAnimation = function (r, m) {
            m.renderer.globalAnimation = a.pick(
                r,
        ...
        a.numberFormat = function (r, m, l, w) {
            ...
            -1 === m
                ...
                ? m &&
                  ...
                  ((B = m + +c[1]),
                  0 <= B
                      ? ((c[0] = (+c[0]).toExponential(B).split("e")[0]),
                        (m = B))
                      : ((c[0] = c[0].split(".")[0] || 0),
                        (r =
                            20 > m
                                ? (c[0] * Math.pow(10, c[1])).toFixed(m)
                                : 0),
                        (c[1] = 0)))
                : (m = 2);
            e = (
                Math.abs(c[1] ? c[0] : r) + Math.pow(10, -Math.max(m, v) - 1)
            ).toFixed(m);
            v = String(a.pInt(e));
        ...
        a.getStyle = function (r, m, l) {
            ...
            if ((r = F.getComputedStyle(r, void 0)))
                (r = r.getPropertyValue(m)),
                    a.pick(l, "opacity" !== m) && (r = a.pInt(r));
            return r;
        };
        ...
        a.map = function (a, m) {
            for (var l = [], w = 0, p = a.length; w < p; w++)
        ...
        a.offset = function (a) {
            ...
            return {
                top:
                    a.top + (F.pageYOffset || m.scrollTop) - (m.clientTop || 0),
                left:
                    a.left +
                    (F.pageXOffset || m.scrollLeft) -
                    (m.clientLeft || 0),
            };
        };
        a.stop = function (r, m) {
        ...
        a.fireEvent = function (r, m, l, w) {
            var p, v, B, e, c;
            l = l || {};
            E.createEvent && (r.dispatchEvent || r.fireEvent)
                ? ((p = E.createEvent("Events")),
                  p.initEvent(m, !0, !0),
                  a.extend(p, l),
                  r.dispatchEvent ? r.dispatchEvent(p) : r.fireEvent(m, p))
        ...
        a.animate = function (r, m, l) {
            ...
            a.objectEach(m, function (c, e) {
                ...
                v = null;
                "d" === e
                    ? ((B.paths = B.initPath(r, r.d, m.d)),
                      (B.toD = m.d),
                      (w = 0),
                      (v = 1))
                    : r.attr
                    ? (w = r.attr(e))
                    : ((w = parseFloat(a.getStyle(r, e)) || 0),
                      "opacity" !== e && (p = "px"));
                v || (v = c);
            ...
            tweenTo: function (a, m) {
                ...
                l.length && p && p.length
                    ? ((a = 1 !== l[3] || 1 !== p[3]),
                      (m =
                          (a ? "rgba(" : "rgb(") +
                          Math.round(l[0] + (p[0] - l[0]) * (1 - m)) +
                          "," +
                          Math.round(l[1] + (p[1] - l[1]) * (1 - m)) +
                          "," +
                          Math.round(l[2] + (p[2] - l[2]) * (1 - m)) +
                          (a ? "," + (l[3] + (p[3] - l[3]) * (1 - m)) : "") +
                          ")"))
                    : (m = a.input || "none");
                return m;
    ...
    (function (a) {
        ...
        g(C.prototype, {
            ...
            init: function (a, h) {
                this.element =
                    "span" === h ? v(h) : k.createElementNS(this.SVG_NS, h);
                this.renderer = a;
            },
            animate: function (h, d, x) {
                d = a.animObject(G(d, this.renderer.globalAnimation, !0));
                0 !== d.duration
                    ? (x && (d.complete = x), r(this, h, d))
                    : (this.attr(h, null, x), d.step && d.step.call(this));
                return this;
            },
            colorGradient: function (h, d, x) {
                ...
                h.radialGradient
                    ? (f = "radialGradient")
                    : h.linearGradient && (f = "linearGradient");
                f &&
                    ((c = h[f]),
                    (n = K.gradients),
                    (t = h.stops),
                    ...
                    n[G]
                        ? (y = n[G].attr("id"))
                        : ((c.id = y = a.uniqueKey()),
                          (n[G] = q = K.createElement(f).attr(c).add(K.defs)),
                          (q.radAttr = e),
                          (q.stops = []),
                          b(t, function (h) {
                              0 === h[1].indexOf("rgba")
            ...
            applyTextOutline: function (h) {
                var K = this.element,
                    ...
                    f,
                    c;
                -1 !== h.indexOf("contrast") &&
                    (h = h.replace(
                        /contrast/g,
                        this.renderer.getContrast(K.style.fill)
                    ));
                h = h.split(" ");
                x = h[h.length - 1];
            ...
            attr: function (a, h, d, x) {
                ...
                "string" === typeof a &&
                    ...
                    ((K = a), (a = {}), (a[K] = h));
                "string" === typeof a
                    ? (f = (this[a + "Getter"] || this._defaultGetter).call(
                          this,
                          a,
                          g
                      ))
            ...
            updateShadows: function (a, h, d) {
                for (var K = this.shadows, x = K.length; x--; )
                    d.call(
                        K[x],
                        "height" === a
                            ? Math.max(h - (K[x].cutHeight || 0), 0)
                            : "d" === a
                            ? this.d
                            : h,
                        a,
            ...
            setRadialReference: function (a) {
                ...
                h &&
                    h.radAttr &&
                    h.animate(this.renderer.getRadialAttr(a, h.radAttr));
                return this;
            },
                    ...
                    : b &&
                      a.push(
                          "rotate(" +
                              b +
                              " " +
                              G(this.rotationOriginX, c.getAttribute("x"), 0) +
                              " " +
                              G(
            ...
            getBBox: function (a, h) {
                ...
                if (!d) {
                    ...
                    x.isSVG &&
                        ...
                        h &&
                            ((d.width =
                                Math.abs(x * Math.sin(f)) +
                                Math.abs(a * Math.cos(f))),
                            (d.height =
                                Math.abs(x * Math.cos(f)) +
            ...
            destroy: function () {
                ...
                g &&
                    x &&
                    (b(
                        x.querySelectorAll("[clip-path],[CLIP-PATH]"),
                        function (a) {
            ...
            fillSetter: function (a, h, d) {
                "string" === typeof a
                    ? d.setAttribute(h, a)
                    : a && this.colorGradient(a, h, d);
            },
            visibilitySetter: function (a, h, d) {
                "inherit" === a
                    ? d.removeAttribute(h)
                    : this[h] !== a && d.setAttribute(h, a);
                this[h] = a;
            },
        ...
        g(E.prototype, {
            ...
            init: function (a, h, d, x, g, b) {
                ...
                -1 === a.innerHTML.indexOf("xmlns") &&
                    m(f, "xmlns", this.SVG_NS);
                this.isSVG = !0;
                this.box = f;
                this.boxWrapper = x;
                this.alignedObjects = [];
                this.url =
                    (q || I) && k.getElementsByTagName("base").length
                        ? Q.location.href
                              .replace(/#.*?$/, "")
                              .replace(/<[^>]*>/g, "")
                              .replace(/([\('\)])/g, "\\$1")
                ...
                this.createElement("desc")
                    .add()
                    .element.appendChild(
                        k.createTextNode("Created with Highstock 6.0.7")
                    );
                ...
                q &&
                    ...
                    h(),
                    (this.unSubPixelFix = F(Q, "resize", h)));
            },
            getStyle: function (a) {
                return (this.style = g(
                    {
            ...
            buildText: function (a) {
                var d = a.element,
                    ...
                    w = function (a) {
                        var g;
                        g = /(px|em)$/.test(a && a.style.fontSize)
                            ? a.style.fontSize
                            : l || x.style.fontSize || 12;
                        return J
                            ? h(J)
                            : x.fontMetrics(g, a.getAttribute("style") ? a : d)
                                  .h;
                    },
                    r = function (a, h) {
                    ...
                    c || N || H || K || -1 !== f.indexOf(" ")
                        ? ((n = /<.*class="([^"]+)".*>/),
                          ...
                          y &&
                              a.attr(
                                  "title",
                                  r(a.textStr, ["\x26lt;", "\x26gt;"])
                              ),
                          D && D.removeChild(d),
                          N && a.applyTextOutline && a.applyTextOutline(N))
                        : d.appendChild(k.createTextNode(r(f)));
                }
            },
            ...
            arc: function (a, h, d, x, b, g) {
                y(a)
                    ? ((x = a), (h = x.y), (d = x.r), (a = x.x))
                    : (x = { innerR: x, start: b, end: g });
            ...
            symbol: function (a, h, d, x, f, c) {
                ...
                A
                    ? ((z = this.path(u)),
                      z.attr("fill", "none"),
                      g(z, { symbolName: t, x: h, y: d, width: x, height: f }),
                      c && g(z, c))
                    : q &&
                      ((y = a.match(n)[1]),
                      (z = this.image(y)),
                      (z.imgwidth = G(M[y] && M[y].width, c && c.width)),
                      (z.imgheight = G(M[y] && M[y].height, c && c.height)),
                      (I = function () {
                      ...
                      B(h) && z.attr({ x: h, y: d }),
                      (z.isImg = !0),
                      B(z.imgwidth) && B(z.imgheight)
                          ? I()
                          : (z.attr({ width: 0, height: 0 }),
                            v("img", {
                                onload: function () {
                ...
                x ||
                    (a.xSetter = function (a, h, d) {
                        ...
                        for (g = 0; g < x.length; g++)
                            (b = x[g]),
                                b.getAttribute(h) === f && b.setAttribute(h, a);
                        d.setAttribute(h, a);
                    });
                return a;
            },
            fontMetrics: function (a, d) {
                ...
                a = /px/.test(a)
                    ...
                    : /em/.test(a)
                    ? parseFloat(a) *
                      (d ? this.fontMetrics(null, d.parentNode).f : 16)
                    : 12;
                d = 24 > a ? a + 3 : Math.round(1.2 * a);
                return { h: d, b: Math.round(0.8 * d), f: a };
            },
            ...
            label: function (h, d, f, c, e, z, n, q, t) {
                ...
                r = function () {
                    ...
                    Q &&
                        (G ||
                            ((u.box = G =
                                A.symbols[c] || K ? A.symbol(c) : A.rect()),
                            G.addClass(
                            ...
                            (h.x = a),
                            (h.y = (q ? -m : 0) + a)),
                        (h.width = Math.round(u.width)),
                        (h.height = Math.round(u.height)),
                        G.attr(g(h, l)),
                        (l = {}));
                };
                Y = function () {
                    ...
                    B(D) &&
                        I &&
                        ("center" === p || "right" === p) &&
                        (a += { center: 0.5, right: 1 }[p] * (D - I.width));
                    if (a !== y.x || h !== y.y)
    ...
    (function (a) {
                ...
                if (this.added) {
                    ...
                    if ("SPAN" === b.tagName) {
                        var y = this.rotation,
                            ...
                            d;
                        (d = I !== this.oldTextWidth) &&
                            !(d = I > this.oldTextWidth) &&
                            ((d = this.textPxLength) ||
                                (F(b, { width: "", whiteSpace: H || "nowrap" }),
                                (d = b.offsetWidth)),
                            (d = d > I));
                        d &&
                            ...
                            (this.oldTextWidth = I));
                        J !== this.cTT &&
                            ((H = a.fontMetrics(b.style.fontSize).b),
                            r(y) &&
                                y !== (this.oldRotation || 0) &&
                                this.setSpanRotation(y, A, H),
        ...
        l(c.prototype, {
            getTransformKey: function () {
                return p && !/Edge/.test(k.navigator.userAgent)
                    ? "-ms-transform"
                    : v
                    ? "-webkit-transform"
                    : w
                    ...
                    ? ((this.get = function (a, c) {
                      ...
                      (this.set = function (e, c, k) {
                          ...
                          if (
                              ...
                              (b = B.getTimezoneOffset(c)),
                                  (b = c.getTime() - b),
                                  c.setTime(b),
                                  c["setUTC" + e](k),
                                  (e = B.getTimezoneOffset(c)),
                                  (b = c.getTime() + e),
                                  c.setTime(b);
                      }))
                    : l
            ...
            makeTime: function (p, l, B, e, c, k) {
                ...
                this.useUTC
                    ? ((b = this.Date.UTC.apply(0, arguments)),
                      (g = this.getTimezoneOffset(b)),
                      (b += g),
                      (n = this.getTimezoneOffset(b)),
                      g !== n
                          ? (b += n - g)
                          : g - 36e5 !== this.getTimezoneOffset(b - 36e5) ||
                            a.isSafari ||
                            (b -= 36e5))
                    : (b = new this.Date(
                          p,
            ...
            dateFormat: function (p, l, m) {
                ...
                a.objectEach(c, function (a, b) {
                    for (; -1 !== p.indexOf("%" + b); )
                        p = p.replace(
                            "%" + b,
                            "function" === typeof a ? a.call(e, l) : a
                        );
                });
            ...
            getTimeTicks: function (a, v, B, e) {
                ...
                if (C(v)) {
                    c.set(
                        ...
                        t >= l.second
                            ? 0
                            : f * Math.floor(c.get("Milliseconds", n) / f)
                    );
                    t >= l.second &&
                        c.set(
                            "Seconds",
                            ...
                            t >= l.minute
                                ? 0
                                : f * Math.floor(c.get("Seconds", n) / f)
                        );
                    t >= l.minute &&
                        c.set(
                            "Minutes",
                            ...
                            t >= l.hour
                                ? 0
                                : f * Math.floor(c.get("Minutes", n) / f)
                        );
                    t >= l.hour &&
                        c.set(
                            "Hours",
                    ...
                    t === l.week &&
                        c.set(
                            "Date",
                            n,
                            c.get("Date", n) - c.get("Day", n) + m(e, 1)
                        );
                    g = c.get("FullYear", n);
                    e = c.get("Month", n);
                    var D = c.get("Date", n),
                    ...
                    c.variableTimezone &&
                        (u =
                            B - v > 4 * l.month ||
                            c.getTimezoneOffset(v) !== c.getTimezoneOffset(B));
                    n = n.getTime();
                    for (v = 1; n < B; )
                        k.push(n),
                            (n =
    ...
    (function (a) {
        ...
        a.setOptions = function (C) {
            ...
            a.time.update(
                E(a.defaultOptions.global, a.defaultOptions.time),
                !1
            );
        ...
        a.Tick.prototype = {
            addLabel: function () {
                ...
                a.isDatetimeAxis &&
                    g &&
                    (f =
                        v.dateTimeLabelFormats[g.higherRanks[k] || g.unitName]);
                this.isFirst = n;
                this.isLast = t;
                ...
                if (E(e)) e && e.attr({ text: v });
                else {
                    if (
                        (this.label = e =
                            E(v) && b.enabled
                                ? B.renderer
                                      .text(v, 0, 0, b.useHTML)
                                      .css(m(b.style))
                                      .add(a.labelGroup)
                                : null)
                    )
            ...
            handleOverflow: function (a) {
                var p = this.axis,
                    ...
                    k = l(
                        p.labelRight,
                        Math.max(p.isRadial ? 0 : p.pos + p.len, c - k[1])
                    ),
                    g = this.label,
                    n = this.rotation,
                    t = { left: 0, center: 0.5, right: 1 }[
                ...
                if (n || !1 === m.overflow)
                    0 > n && e - t * f < b
                        ? (A = Math.round(e / Math.cos(n * w) - b))
                        : 0 < n &&
                          e + t * f > k &&
                          (A = Math.round((c - e) / Math.cos(n * w)));
                else if (
                    ((c = e + (1 - t) * f),
                    e - t * f < b
                        ? (D = a.x + D * (1 - t) - b)
                    ...
                    D < u &&
                        "center" === p.labelAlign &&
                        (a.x += q * (u - D - t * (u - Math.min(f, D)))),
                    f > D || (p.autoRotation && (g.styles || {}).width))
                )
                    A = D;
                A &&
                    ((y.width = A),
            ...
            getPosition: function (l, m, B, e) {
                ...
                return {
                    x: l
                        ? a.correctFloat(
                              c.translate(m + B, null, null, e) + c.transB
                          )
                        : c.left +
                          c.offset +
                          (c.opposite
                              ? ((e && k.oldChartWidth) || k.chartWidth) -
                                c.right -
                                c.left
                              : 0),
                    y: l
                        ? b - c.bottom + c.offset - (c.opposite ? c.height : 0)
                        : a.correctFloat(
                              b - c.translate(m + B, null, null, e) - c.transB
                          ),
                };
            },
            getLabelPosition: function (a, l, m, e, c, k, b, g) {
                var n = this.axis,
                    ...
                    f = n.reversed,
                    u = n.staggerLines,
                    D = n.tickRotCorr || { x: 0, y: 0 },
                    q = c.y,
                    A =
                        e || n.reserveSpaceDefault
                            ? 0
                            : -n.labelOffset *
                              ("center" === n.labelAlign ? 0.5 : 1);
                E(q) ||
                    (q =
                        0 === n.side
                            ? m.rotation
                            ...
                            : 2 === n.side
                            ? D.y + 8
                            : Math.cos(m.rotation * w) *
                              (D.y - m.getBBox(!1, 0).height / 2));
            ...
            renderGridLine: function (a, l, m) {
                ...
                if (
                    !a &&
                    k &&
                    (a = e.getPlotLinePath(g + t, k.strokeWidth() * m, a, !0))
                )
                    k[this.isNew ? "attr" : "animate"]({ d: a, opacity: l });
            },
                    ...
                    f &&
                        ((this.mark = t =
                            k
                                ...
                                .add(e.axisGroup)),
                        t.attr({ stroke: c, "stroke-width": D })),
                    t[f ? "attr" : "animate"]({
                        d: this.getMarkPath(
                            u,
                            a,
            ...
            renderLabel: function (a, m, B, e) {
                ...
                g &&
                    r(u) &&
                    ((g.xy = a = this.getLabelPosition(u, a, g, k, n, c, e, t)),
                    (this.isFirst && !this.isLast && !l(b.showFirstLabel, 1)) ||
                    (this.isLast && !this.isFirst && !l(b.showLastLabel, 1))
                        ? (f = !1)
                        : !k ||
                          n.step ||
                          n.rotation ||
    ...
    var da = (function (a) {
        ...
        a.extend(G.prototype, {
            ...
            init: function (a, d) {
                ...
                x.side =
                    d.side ||
                    (x.horiz ? (x.opposite ? 0 : 2) : x.opposite ? 1 : 3);
                x.setOptions(d);
                var b = this.options,
                    f = b.type;
                x.labelFormatter =
                    b.labels.formatter || x.defaultLabelFormatter;
                x.userOptions = d;
                x.minPixelPadding = 0;
                ...
                x.crosshair = H(
                    b.crosshair,
                    J(a.options.tooltip.crosshairs)[h ? 0 : 1],
                    !1
                );
                d = x.options.events;
                -1 === t(x, a.axes) &&
                    (h ? a.axes.splice(a.xAxis.length, 0, x) : a.axes.push(x),
                    a[x.coll].push(x));
                x.series = x.series || [];
                a.inverted &&
                    !x.isZAxis &&
                    ...
                    for (; n-- && void 0 === q; )
                        (f = Math.pow(e, n + 1)),
                            h >= f &&
                                ...
                                null !== z[n] &&
                                0 !== d &&
                                (q = a.numberFormat(d / f, -1) + z[n]);
                void 0 === q &&
                    (q =
                        1e4 <= Math.abs(d)
                            ? a.numberFormat(d, -1)
                            : a.numberFormat(d, -1, void 0, ""));
                return q;
            },
                    ...
                    if (h.visible || !d.options.chart.ignoreHiddenSeries) {
                        ...
                        if (a.isXAxis)
                            ...
                            p(h) &&
                                ...
                                (a.dataMax = Math.max(H(a.dataMax, f), f))),
                            p(b) && (a.threshold = b),
                            !x.softThreshold || a.positiveValuesOnly)
                        )
                            a.softThreshold = !1;
                    }
                });
            ...
            translate: function (a, d, b, f, c, g) {
                ...
                d
                    ? ((a = (a * x + e - q) / z + f), c && (a = h.lin2val(a)))
                    : (c && (a = h.val2lin(a)),
                      (a = u(f)
                          ? x * (a - f) * z + e + x * q + (u(g) ? z * g : 0)
                          : void 0));
                return a;
            },
            ...
            getPlotLinePath: function (a, d, b, f, c) {
                ...
                u(c)
                    ? this.horiz
                        ? ((e = g),
                          (z = q - this.bottom),
                          (a = b = A(a, x, x + this.width)))
                        : ((a = x),
                          (b = n - this.right),
                          (e = z = A(e, g, g + this.height)))
                    : ((t = !0), (f = !1));
                return t && !f
                    ? null
                    : h.renderer.crispLine(["M", a, e, "L", b, z], d || 1);
            },
                    ...
                    if (a.isLog)
                        e(this.paddedTicks, function (h, d, x) {
                            d &&
                                c.push.apply(
                                    c,
                                    a.getLogTickPositions(f, x[d - 1], x[d], !0)
                                );
                        });
                    else if (
                        a.isDatetimeAxis &&
            ...
            setAxisTranslation: function (a) {
                ...
                if (t || q || b)
                    (f = h.getClosest()),
                        z
                            ? ((c = z.minPointOffset),
                              (g = z.pointRangePadding))
                            : e(h.series, function (a) {
                                  var d = q
                                      ? 1
                                      : t
                                      ? H(a.options.pointRange, f, 0)
                                      : h.axisPointRange || 0;
                                  a = a.options.pointPlacement;
                                  b = Math.max(b, d);
                                  h.single ||
                                      ((c = Math.max(c, D(a) ? 0 : d / 2)),
                                      (g = Math.max(g, "on" === a ? 0 : d)));
                              }),
                        (z = h.ordinalSlope && f ? h.ordinalSlope / f : 1),
                        (h.minPointOffset = c *= z),
                        (h.pointRangePadding = g *= z),
                        (h.pointRange = Math.min(b, d)),
                        t && (h.closestPointRange = f);
                a && (h.oldTransA = n);
                h.translationSlope =
                    h.transA =
                    n =
                        h.options.staticScale || h.len / (d + g || 1);
            ...
            setTickInterval: function (h) {
                ...
                C = H(d.userMax, f.max);
                t
                    ? ((d.linkedParent = b[d.coll][f.linkedTo]),
                      (b = d.linkedParent.getExtremes()),
                      (d.min = H(b.min, b.dataMin)),
                      (d.max = H(b.max, b.dataMax)),
                      f.type !== d.linkedParent.options.type && a.error(11, 1))
                    : (!v &&
                          p(m) &&
                          (d.dataMin >= m
                              ? ((B = m), (y = 0))
                              : d.dataMax <= m && ((w = m), (G = 0))),
                      (d.min = H(r, B, d.dataMin)),
                      (d.max = H(C, w, d.dataMax)));
                c &&
                    (d.positiveValuesOnly &&
                        !h &&
                        0 >= Math.min(d.min, H(d.dataMin, d.min)) &&
                        a.error(10, 1),
                    (d.min = l(z(d.min), 15)),
                    (d.max = l(z(d.max), 15)));
                d.range &&
                    ...
                    ((d.userMin =
                        d.min =
                        r =
                            Math.max(d.dataMin, d.minFromRange())),
                    (d.userMax = C = d.max),
                    (d.range = null));
                k(d, "foundExtremes");
                d.beforePadding && d.beforePadding();
                d.adjustForMinRange();
                !(J || d.axisPointRange || d.usePercentage || t) &&
                    p(d.min) &&
                    p(d.max) &&
                    (z = d.max - d.min) &&
                    (!p(r) && y && (d.min -= z * y),
                ...
                u(f.softMin) &&
                    !u(d.userMin) &&
                    (d.min = Math.min(d.min, f.softMin));
                u(f.softMax) &&
                    !u(d.userMax) &&
                    (d.max = Math.max(d.max, f.softMax));
                u(f.floor) && (d.min = Math.max(d.min, f.floor));
                u(f.ceiling) && (d.max = Math.min(d.max, f.ceiling));
                v &&
                    p(d.dataMin) &&
                    ((m = m || 0),
                    !p(r) && d.min < m && d.dataMin >= m
                        ? (d.min = m)
                        : !p(C) && d.max > m && d.dataMax <= m && (d.max = m));
                d.tickInterval =
                    d.min === d.max || void 0 === d.min || void 0 === d.max
                        ? 1
                        : t &&
                          !I &&
                          D === d.linkedParent.options.tickPixelInterval
                        ? (I = d.linkedParent.tickInterval)
                        : H(
                              I,
                              this.tickAmount
                                  ? (d.max - d.min) /
                                  ...
                                  : void 0,
                              J ? 1 : ((d.max - d.min) * D) / Math.max(d.len, D)
                          );
                n &&
                    !h &&
                ...
                d.postProcessTickInterval &&
                    (d.tickInterval = d.postProcessTickInterval(
                        d.tickInterval
                    ));
                d.pointRange &&
                    !I &&
            ...
            alignToOthers: function () {
                ...
                !1 === this.chart.options.chart.alignTicks ||
                    !1 === b.alignTicks ||
                    this.isLog ||
                    e(this.chart[this.coll], function (h) {
                        var b = h.options,
                            b = [
                                h.horiz ? b.left : b.top,
                                b.width,
                                b.height,
                                b.pane,
                            ].join();
            ...
            adjustTickAmount: function () {
                ...
                if (this.hasData()) {
                    if (c < b) {
                        for (; d.length < b; )
                            d.length % 2 || this.min === g
                                ? d.push(l(d[d.length - 1] + a))
                                : d.unshift(l(d[0] - a));
                        this.transA *= (c - 1) / (b - 1);
                        this.min = d[0];
            ...
            zoom: function (a, d) {
                ...
                if (a !== this.min || d !== this.max)
                    this.allowZoomOutside ||
                        (p(h) && (a < c && (a = c), a > f && (a = f)),
                        p(b) && (d < c && (d = c), d > f && (d = f))),
                        (this.displayBtn = void 0 !== a || void 0 !== d),
                        this.setExtremes(a, d, !1, void 0, { trigger: "zoom" });
                return !0;
            },
            setAxisSize: function () {
                var d = this.chart,
                    ...
                    g = (this.width = Math.round(
                        a.relativeLength(
                            H(b.width, d.plotWidth - f[3] + f[1]),
                            d.plotWidth
                        )
                    )),
                    z = (this.height = Math.round(
                        a.relativeLength(
                            H(b.height, d.plotHeight - f[0] + f[2]),
                            d.plotHeight
                        )
                    )),
                    e = (this.top = Math.round(
                        a.relativeLength(
                            H(b.top, d.plotTop + f[0]),
                            d.plotHeight,
                            d.plotTop
                        )
                    )),
            ...
            unsquish: function () {
                ...
                d
                    ? (u =
                          ...
                          (p(z)
                              ? [z]
                              : c < H(a.autoRotationLimit, 80) &&
                                a.autoRotation)) &&
                      e(u, function (a) {
                          var d;
                          if (a === z || (a && -90 <= a && 90 >= a))
                              (n = A(Math.abs(q.h / Math.sin(v * a)))),
                                  (d = n + Math.abs(a / 360)),
                                  d < t && ((t = d), (g = a), (f = n));
                      })
                    : a.step || (f = A(q.h));
            ...
            renderUnsquish: function () {
                ...
                e(b, function (a) {
                    (a = f[a]) &&
                        a.label &&
                        a.label.textPxLength > y &&
                        (y = a.label.textPxLength);
                });
            ...
            getOffset: function () {
                ...
                t || a.isLinked
                    ? (e(c, function (d, b) {
                      ...
                      (a.labelOffset = J * (a.opposite ? -1 : 1)))
                    : y(g, function (a, d) {
                          a.destroy();
                          delete g[d];
                      });
                k &&
                    ...
                    u &&
                        !1 !== k.reserveSpace &&
                        ((a.titleOffset = A =
                            a.axisTitle.getBBox()[z ? "height" : "width"]),
                        (G = k.offset),
                        (I = p(G) ? 0 : H(k.margin, z ? 5 : 10))));
                a.renderLine();
                ...
                J &&
                    (I =
                        I -
                        b +
                        m * (z ? H(D.y, a.tickRotCorr.y + 8 * m) : D.x));
                a.axisTitleMargin = H(G, I);
                l[q] = Math.max(
                    l[q],
                    a.axisTitleMargin + A + m * a.offset,
                    I,
                    t && c.length && w ? w[0] + m * a.offset : 0
                );
            ...
            getLinePath: function (a) {
                ...
                return d.renderer.crispLine(
                    [
                        ...
                        f ? h : this.top,
                        "L",
                        f ? d.chartWidth - this.right : c,
                        f ? h : d.chartHeight - this.bottom,
                    ],
                    a
                );
            },
            ...
            getTitlePosition: function () {
                var a = this.horiz,
                    ...
                    d =
                        (a ? b + this.height : d) +
                        (a ? 1 : -1) * (z ? -1 : 1) * this.axisTitleMargin +
                        [-t, t, u.f, -t][this.side];
                return {
            ...
            renderTick: function (a, d) {
                ...
                if (!b || (a >= this.min && a <= this.max))
                    h[a] || (h[a] = new z(this, a)),
                        f && h[a].isNew && h[a].render(d, !0, 0.1),
                        h[a].render(d);
            },
            render: function () {
                var b = this,
                        ...
                        J &&
                            e(t, function (d, h) {
                                ...
                                0 === h % 2 &&
                                    d < b.max &&
                                    B <= b.max + (f.polar ? -H : H) &&
                                    (k[d] || (k[d] = new a.PlotLineOrBand(b)),
                                    (v = d + H),
                                    (k[d].options = {
                                        from: g ? q(v) : v,
                                        to: g ? q(B) : B,
                ...
                A &&
                    ...
                    u(c.y)
                        ? (A[A.isNew ? "attr" : "animate"](c), (A.isNew = !1))
                        : (A.attr("y", -9999), (A.isNew = !0)));
            ...
            destroy: function (a) {
                ...
                for (f in d.plotLinesAndBandsGroups)
                    d.plotLinesAndBandsGroups[f] =
                        d.plotLinesAndBandsGroups[f].destroy();
                y(d, function (a, b) {
            ...
            drawCrosshair: function (a, d) {
                ...
                this.crosshair && !1 !== (p(d) || !h)
                    ? (h
                          ? p(d) &&
                            (c = this.isXAxis ? d.plotX : this.len - d.plotY)
                          : (c =
                                a &&
                                (this.horiz
                                    ? a.chartX - this.pos
                      ...
                      p(c) &&
                          (b =
                              this.getPlotLinePath(
                                  d && (this.isXAxis ? d.x : H(d.stackY, d.y)),
                                  null,
                                  null,
                                  null,
                                  c
    ...
    (function (a) {
        ...
        C.prototype.normalizeTimeTickInterval = function (a, l) {
            ...
            for (
                ...
                (p = r[l[0]]),
                (v = l[1]),
                m[B + 1] && a <= (p * v[v.length - 1] + r[m[B + 1][0]]) / 2);
                B++
            );
            ...
            if (0.5 <= a)
                ...
                (w = c(w)),
                    ...
                    (a = m(
                        ...
                        ((l.tickPixelInterval / (v ? 5 : 1)) * (p - w)) /
                            ((v ? e / this.tickPositions.length : e) || 1)
                    )),
                    (a = r(a, null, E(a))),
                    (b = F(this.getLinearTickPositions(a, w, p), k)),
    ...
    (function (a, C) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function () {
                ...
                D
                    ? ((y = { stroke: H, "stroke-width": k.width }),
                      k.dashStyle && (y.dashstyle = k.dashStyle))
                    : u &&
                      (H && (y.fill = H),
                      k.borderWidth &&
                          ((y.stroke = k.borderColor),
                          (y["stroke-width"] = k.borderWidth)));
                d.zIndex = I;
                G += "-" + I;
                (H = e.plotLinesAndBandsGroups[G]) ||
                    (e.plotLinesAndBandsGroups[G] = H =
                        z
                            .g("plot-" + G)
                            .attr(d)
                            .add());
                A && (l.svgElem = q = z.path().attr(y).add(H));
                if (D) y = e.getPlotLinePath(f, q.strokeWidth());
                else if (u) y = e.getPlotBandPath(t, n, k);
                else return;
                A && y && y.length
                    ? (q.attr({ d: y }),
                      J &&
                          a.objectEach(J, function (a, d) {
                              q.on(d, function (a) {
                                  J[d].apply(l, [a]);
                              });
                          }))
                    : q &&
                      (y
                          ? (q.show(), q.animate({ d: y }))
                          : (q.hide(), g && (l.label = g = g.destroy())));
                b &&
                r(b.text) &&
                y &&
                y.length &&
            ...
            renderLabel: function (a, e, c, k) {
                ...
                b ||
                    ...
                    (b.zIndex = k),
                    (this.label = b =
                        g.text(a.text, 0, 0, a.useHTML).attr(b).add()),
                    b.css(a.style));
        ...
        a.extend(C.prototype, {
            ...
            removePlotBandOrLine: function (a) {
                ...
                l(
                    ...
                    function (c) {
                        for (b = c.length; b--; ) c[b].id === a && w(c, c[b]);
                    }
                );
            },
    ...
    (function (a) {
        ...
        a.Tooltip.prototype = {
            ...
            move: function (a, c, k, b) {
                var g = this,
                    ...
                    t =
                        ...
                        !g.isHidden &&
                        (1 < Math.abs(a - e.x) || 1 < Math.abs(c - e.y)),
            ...
            getAnchor: function (a, c) {
                ...
                this.followPointer &&
                    c &&
                    (void 0 === c.chartX && (c = b.pointer.normalize(c)),
                    (e = [c.chartX - b.plotLeft, c.chartY - n]));
                e ||
                    (C(a, function (a) {
                        D = a.series.yAxis;
                        q = a.series.xAxis;
                        ...
                        u +=
                            (a.plotLow
                                ...
                                : a.plotY) + (!g && D ? D.top - n : 0);
                    }),
                    (f /= a.length),
                    (u /= a.length),
                    (e = [
                        g ? b.plotWidth - u : f,
                        this.shared && !g && 1 < a.length && c
                            ? c.chartY - n
                            : g
                            ? b.plotHeight - f
                            : u,
            ...
            getPosition: function (a, c, k) {
                var b = this.chart,
                    ...
                    q =
                        !this.followPointer &&
                        w(k.ttBelow, !b.inverted === !!k.negative),
            ...
            refresh: function (a, c) {
                ...
                b.enabled &&
                    (clearTimeout(this.hideTimer),
                    (this.followPointer =
                        p(n)[0].series.tooltipOptions.followPointer),
                    (t = this.getAnchor(n, c)),
                    (c = t[0]),
                    (g = t[1]),
                    !f || (n.series && n.series.noSharedTooltip)
                        ? (f = n.getLabelConfig())
                        : (C(n, function (a) {
                              a.setState("hover");
                              u.push(a.getLabelConfig());
                          }),
                          (f = { x: n[0].category, y: n[0].y }),
                          (f.points = u),
                          (n = n[0])),
                    (this.len = u.length),
                    (f = e.call(f, this)),
                    ...
                    !1 === f
                        ...
                        : ((e = this.getLabel()),
                          ...
                          this.split
                              ? this.renderSplit(f, p(a))
                              : (b.style.width ||
                                    e.css({
                                        width: this.chart.spacingBox.width,
                                    }),
                                e.attr({ text: f && f.join ? f.join("") : f }),
                                e
                                    .removeClass(/highcharts-color-[\d]+/g)
                                    .addClass(
                                        "highcharts-color-" +
                                            w(n.colorIndex, D.colorIndex)
                                    ),
                                e.attr({
                                    stroke:
                                        b.borderColor ||
            ...
            renderSplit: function (e, c) {
                ...
                C(e.slice(0, c.length + 1), function (a, e) {
                    if (!1 !== a) {
                        e = c[e - 1] || { isHeader: !0, plotX: c[0].plotX };
                        var q = e.series || k,
                            A = q.tt,
                            I = e.series || {},
                            J =
                                "highcharts-color-" +
                                w(e.colorIndex, I.colorIndex, "none");
                        A ||
                            (q.tt = A =
                                n
                                    .label(
                                    ...
                                    .addClass("highcharts-tooltip-box " + J)
                                    .attr({
                                        padding: f.padding,
                                        r: f.borderRadius,
                        ...
                        e.isHeader
                            ? ((u = a.height),
                              (I = Math.max(
                                  0,
                                  Math.min(
                                      e.plotX + g.plotLeft - I / 2,
                                      g.chartWidth - I
                                  )
                              )))
                            : (I =
                                  e.plotX + g.plotLeft - w(f.distance, 16) - I);
                        0 > I && (t = !1);
                        a =
                ...
                C(b, function (a) {
                    ...
                    a.tt.attr({
                        ...
                        x:
                            t || b.isHeader
                                ? a.x
                                : b.plotX + g.plotLeft + w(f.distance, 16),
                        y: a.pos + g.plotTop,
                        anchorX: b.isHeader
                            ? b.plotX + g.plotLeft
                            : b.plotX + c.xAxis.pos,
            ...
            getDateFormat: function (a, c, k, b) {
                ...
                for (f in B) {
                    ...
                    if (
                        u[f] &&
                        e.substr(u[f]) !== "01-01 00:00:00.000".substr(u[f])
                    )
                        break;
                    "week" !== f && (D = f);
                }
            ...
            getXDateFormat: function (a, c, k) {
                ...
                return (
                    (b
                        ? this.getDateFormat(b, a.x, k.options.startOfWeek, c)
                        : c.day) || c.year
                );
            },
    ...
    (function (a) {
        ...
        a.Pointer.prototype = {
            init: function (a, f) {
                ...
                this.lastValidTouch = {};
                n &&
                    ((a.tooltip = new n(a, f.tooltip)),
                    (this.followTouchMove = b(f.tooltip.followTouchMove, !0)));
                this.setDOMEvents();
            },
            ...
            runPointActions: function (c, f) {
                var g = this.chart,
                    e =
                        g.tooltip && g.tooltip.options.enabled
                            ? g.tooltip
                            : void 0,
                    n = e ? e.shared : !1,
                    t = f || g.hoverPoint,
                    ...
                    y = this.getHoverData(
                        ...
                        y,
                        g.series,
                        !!f || (y && y.directTouch && this.isDirectTouch),
                        n,
                        c,
                ...
                if (t && (t !== g.hoverPoint || (e && e.isHidden))) {
                    ...
                    f &&
                        ...
                        !e.isHidden &&
                        ((t = e.getAnchor([{}], c)),
                        e.updatePosition({ plotX: t[0], plotY: t[1] }));
                this.unDocMouseMove ||
                ...
                w(f.series, function (g) {
                    ...
                    g.xAxis &&
                        ...
                        g.markerGroup &&
                            ...
                            g.markerGroup.clip(b ? f.clipRect : null)),
            ...
            drag: function (a) {
                ...
                (G && G.touch) ||
                    ...
                    (this.hasDragged = Math.sqrt(
                        Math.pow(h - g, 2) + Math.pow(x - e, 2)
                    )),
                    10 < this.hasDragged &&
                        ((z = b.isInsidePlot(h - k, x - I)),
            ...
            drop: function (a) {
                ...
                if (this.selectionMarker) {
                    var n = { originalEvent: a, xAxis: [], yAxis: [] },
            ...
            onContainerMouseLeave: function (b) {
                ...
                f &&
                    ...
                    (f.pointer.reset(), (f.pointer.chartPosition = null));
            },
            ...
            onContainerClick: function (a) {
                ...
                b.cancelClick ||
                    (c && this.inClass(a.target, "highcharts-tracker")
                        ? (B(c.series, "click", p(a, { point: c })),
                          b.hoverPoint && c.firePointEvent("click", a))
                        : (p(a, this.getCoordinates(a)),
                          b.isInsidePlot(a.chartX - g, a.chartY - e) &&
                              B(b, "click", a)));
            },
    ...
    (function (a) {
        ...
        F(a.Pointer.prototype, {
            pinchTranslate: function (a, l, m, r, e, c) {
                this.zoomHor &&
                    this.pinchTranslateDirection(!0, a, l, m, r, e, c);
                this.zoomVert &&
                    this.pinchTranslateDirection(!1, a, l, m, r, e, c);
            },
            ...
            pinch: function (a) {
                var p = this,
                    ...
                    t =
                        1 === c &&
                        ((p.inClass(a.target, "highcharts-tracker") &&
                            v.runTrackerClick) ||
                            p.runChartClick),
                    f = {};
                1 < c && (p.initiated = !0);
                ...
                "touchstart" === a.type
                    ? (E(e, function (a, b) {
                      ...
                      (k.x = [w[0].chartX, w[1] && w[1].chartX]),
                      (k.y = [w[0].chartY, w[1] && w[1].chartY]),
                      E(v.axes, function (a) {
                          if (a.zoomEnabled) {
                    ...
                    : w.length &&
                      (g ||
                          (p.selectionMarker = g =
                              F({ destroy: m, touch: !0 }, v.plotBox)),
                      p.pinchTranslate(w, e, n, g, f, k),
                      (p.hasPinched = b),
                      p.scaleGroups(n, f),
                ...
                1 === m.touches.length
                    ? ((m = this.normalize(m)),
                      (e = v.isInsidePlot(
                          ...
                          ? (p && this.runPointActions(m),
                            "touchmove" === m.type &&
                                ((p = this.pinchDown),
                                (r = p[0]
                                    ? 4 <=
                                      Math.sqrt(
                                          Math.pow(p[0].chartX - m.chartX, 2) +
                                              Math.pow(
                                                  p[0].chartY - m.chartY,
                                                  2
                                              )
                            ...
                            l(r, !0) && this.pinch(m))
                          : p && this.reset())
                    : 2 === m.touches.length && this.pinch(m);
            },
            ...
            m(w.prototype, {
                ...
                onContainerPointerMove: function (a) {
                    b(a, "onContainerTouchMove", "touchmove", function (a) {
                        ...
                        e[a.pointerId].target ||
                            (e[a.pointerId].target = a.currentTarget);
                    });
                },
    ...
    (function (a) {
        ...
        a.Legend.prototype = {
            ...
            colorizeItem: function (a, c) {
                ...
                var b = this.options,
                    ...
                    y = { fill: q };
                g && g.css({ fill: b, color: b });
                f && f.attr({ stroke: q });
                e &&
                    (A &&
                        e.isMarker &&
                        ((y = a.pointAttribs()), c || (y.stroke = y.fill = k)),
                    e.attr(y));
            },
            positionItem: function (a) {
                ...
                (a = a.legendGroup) &&
                    a.element &&
                    a.translate(b ? f : this.legendWidth - f - 2 * c - 4, e);
                k && ((k.x = f), (k.y = e));
            },
            ...
            renderItem: function (a) {
                ...
                G ||
                    ...
                    (a.legendItem = G =
                        c
                            .text("", I ? k + l : -l, this.baseline || 0, P)
                            .css(p(a.visible ? q : A))
                            .attr({ align: I ? "left" : "right", zIndex: 2 })
                            .add(a.legendGroup)),
                    this.baseline ||
                        ((k = q.fontSize),
                        (this.fontMetrics = c.fontMetrics(k, G)),
                        (this.baseline = this.fontMetrics.f + 3 + z),
                    ...
                    O && this.createCheckboxForItem(a));
                this.colorizeItem(a, a.visible);
                q.width ||
                    G.css({
                        width:
                            (e.itemWidth || e.width || b.spacingBox.width) - r,
                    });
                this.setText(a);
                c = G.getBBox();
                q = a.checkboxOffset =
                    e.itemWidth || a.legendItemWidth || c.width + r;
                this.itemHeight = c = Math.round(
                    a.legendItemHeight || c.height || this.symbolHeight
                );
                f &&
                    this.itemX - y + q >
                        (J || b.spacingBox.width - 2 * y - e.x) &&
                    ((this.itemX = y),
                    (this.itemY += z + this.lastLineHeight + d),
                ...
                f
                    ? (this.itemX += q)
                    : ((this.itemY += z + c + d), (this.lastLineHeight = c));
                this.offsetWidth =
                    J ||
                    Math.max(
                        (f ? this.itemX - y - (a.checkbox ? 0 : m) : q) + y,
                        this.offsetWidth
                    );
            },
            getAllItems: function () {
                ...
                m(this.chart.series, function (b) {
                    var c = b && b.options;
                    b &&
                        v(c.showInLegend, r(c.linkedTo) ? !1 : void 0, !0) &&
                        (a = a.concat(
                            b.legendItems ||
            ...
            render: function () {
                ...
                a.lastItemY = 0;
                k ||
                    ((a.group = k = n.g("legend").attr({ zIndex: 7 }).add()),
                    (a.contentGroup = n.g().attr({ zIndex: 1 }).add(k)),
                    (a.scrollGroup = n.g().add(a.contentGroup)));
                a.renderTitle();
                f = a.getAllItems();
                e(f, function (a, b) {
                    return (
                ...
                u &&
                    ...
                    /(lth|ct|rth)/.test(a.getAlignment()) &&
                        (n = p(n, {
                            y: n.y + c.titleOffset + c.options.title.margin,
                        })),
                    k.align(p(y, { width: l, height: q }), !0, n));
            ...
            handleOverflow: function (a) {
                ...
                a > c && !1 !== y.enabled
                    ? ((this.clipHeight = q =
                          Math.max(c - 20 - this.titleHeight - l, 0)),
                      ...
                      A ||
                          ((A = b.clipRect = e.clipRect(0, l, 9999, 0)),
            ...
            scroll: function (a, c) {
                ...
                0 < a &&
                    ...
                    this.down
                        .attr({
                            fill: a === e ? g.inactiveColor : g.activeColor,
                        })
                        .css({ cursor: a === e ? "default" : "pointer" }),
        ...
        a.LegendSymbolMixin = {
            ...
            drawLineMarker: function (a) {
                ...
                c &&
                    !1 !== c.enabled &&
                    ((b = Math.min(v(c.radius, k), k)),
                    0 === this.symbol.indexOf("url") &&
                        ((c = p(c, { width: f, height: f })), (b = 0)),
                    (this.legendSymbol = c =
                        l
                            .symbol(
                                this.symbol,
        ...
        (/Trident\/7\.0/.test(c.navigator.userAgent) || l) &&
            k(a.Legend.prototype, "positionItem", function (a, c) {
                var b = this,
                    e = function () {
        ...
        b(O.prototype, {
            ...
            init: function (d, b) {
                ...
                for (f in c.plotOptions)
                    c.plotOptions[f].tooltip =
                        (e[f] && y(e[f].tooltip)) || void 0;
            ...
            initSeries: function (d) {
                ...
                (b = G[d.type || b.type || b.defaultSeriesType]) ||
                    a.error(17, !0);
                b = new b();
                b.init(this, d);
                return b;
            ...
            redraw: function (d) {
                ...
                for (d = f.length; d--; )
                    if (
                        ((y = f[d]),
                        y.options.stacking && ((z = !0), y.isDirty))
                    ) {
                        q = !0;
                        break;
                    }
                ...
                k(f, function (a) {
                    a.isDirty &&
                        ...
                        (a.updateTotals && a.updateTotals(), (g = !0));
            ...
            layOutTitles: function (a) {
                ...
                k(
                    ...
                    function (a) {
                        ...
                        c &&
                            ((g = e.style.fontSize),
                            (g = f.fontMetrics(g, c).b),
                            c
                                .css({
                                    width:
                                        (e.width || h.width + e.widthAdjust) +
                                        "px",
                                })
                                .align(b({ y: a + g }, e), !1, "spacingBox"),
                            e.floating ||
                                e.verticalAlign ||
                                (d = Math.ceil(
                                    d + c.getBBox(e.useHTML).height
                                )));
                    },
                    this
                );
            ...
            getChartSize: function () {
                ...
                this.chartHeight = Math.max(
                    0,
                    a.relativeLength(d, this.chartWidth) ||
            ...
            temporaryDisplay: function (d) {
                ...
                if (d)
                    for (; b && b.style; )
                        b.hcOrigStyle &&
                            (a.css(b, b.hcOrigStyle), delete b.hcOrigStyle),
                            b.hcOrigDetached &&
                    ...
                    for (; b && b.style; ) {
                        m.body.contains(b) ||
                            b.parentNode ||
                            ((b.hcOrigDetached = !0), m.body.appendChild(b));
                        if (
                            "none" === a.getStyle(b, "display", !1) ||
                            b.hcOricDetached
                        )
                            (b.hcOrigStyle = {
                                ...
                                (d = { display: "block", overflow: "hidden" }),
                                b !== this.renderTo && (d.height = 0),
                                a.css(b, d),
                                b.offsetWidth ||
                                    b.style.setProperty(
                                        "display",
            ...
            getMargins: function (a) {
                ...
                f &&
                    ...
                    (this.plotTop = Math.max(
                        this.plotTop,
                        f + this.options.title.margin + d[0]
                    ));
                this.legend &&
                    this.legend.display &&
                    this.legend.adjustMargins(b, d);
                this.extraMargin &&
            ...
            setChartSize: function (a) {
                ...
                this.plotWidth = x = Math.max(
                    0,
                    Math.round(c - z - this.marginRight)
                );
                this.plotHeight = n = Math.max(
                    0,
                    Math.round(f - q - this.marginBottom)
                );
                ...
                this.clipBox = {
                    ...
                    y: b,
                    width: Math.floor(
                        this.plotSizeX - Math.max(c, g[1]) / 2 - d
                    ),
                    height: Math.max(
                        0,
                        Math.floor(this.plotSizeY - Math.max(c, g[2]) / 2 - b)
                    ),
                };
                a ||
            ...
            drawChartBox: function () {
                ...
                f ||
                    ((this.chartBackground = f =
                        d.rect().addClass("highcharts-background").add()),
                    (m = "attr"));
                g = a.borderWidth || 0;
                G = g + (a.shadow ? 8 : 0);
                q = { fill: q || "none" };
                ...
                h ||
                    ...
                    (this.plotBackground = h =
                        d.rect().addClass("highcharts-plot-background").add()));
                h[m](u);
                h.attr({ fill: k || "none" }).shadow(a.plotShadow);
                x &&
                    (z
                        ? z.animate(u)
                        : (this.plotBGImage = d.image(x, y, I, A, t).add()));
                J
                    ? J.animate({ width: l.width, height: l.height })
            ...
            },
            {
                ...
                getCyclic: function (a, b, d) {
                    var c,
                        ...
                        q = d
                            ? d.length
                            : u(f.options.chart[a + "Count"], f[a + "Count"]);
                    b ||
                        ((c = u(h[e], h["_" + e])),
                        p(c) ||
                            (f.series.length || (f[g] = 0),
                            (h["_" + e] = c = f[g] % q),
                            (f[g] += 1)),
                        d && (b = d[c]));
                    void 0 !== c && (this[e] = c);
                ...
                getColor: function () {
                    this.options.colorByPoint
                        ...
                        : this.getCyclic(
                              "color",
                              this.options.color || w[this.type].color,
                    ...
                    if (
                        ...
                        if (l && k > l) {
                            ...
                            for (d = 0; d < k; d++)
                                void 0 !== c[d] &&
                                    ((t = { series: z }),
                                    z.pointClass.prototype.applyOptions.apply(
                                        t,
                                        [c[d]]
                                    ),
                ...
                processData: function (b) {
                    ...
                    if (
                        ...
                        this.sorted &&
                        !y &&
                        (!k || f > k || this.forceCrop)
                    )
                        if (c[f - 1] < I || c[0] > l) (c = []), (d = []);
                        else if (c[0] < I || c[f - 1] > l)
                            (e = this.cropData(this.xData, this.yData, I, l)),
                                (c = e.xData),
                                (d = e.yData),
                                (e = e.start),
                                (h = !0);
                ...
                generatePoints: function () {
                    ...
                    d ||
                        y ||
                        ((d = []), (d.length = b.length), (d = this.data = d));
                        ...
                        (n = k + u),
                            y
                                ? ((A = new e().init(
                                  ...
                                  (A.dataGroup = this.groupMap[u]))
                                : (A = d[n]) ||
                                  void 0 === b[n] ||
                                  (d[n] = A = new e().init(this, b[n], f[u])),
                            A && ((A.index = n), (t[u] = A));
                    this.options.keys = a;
                    if (d && (g !== (c = d.length) || y))
                        for (u = 0; u < c; u++)
                ...
                getExtremes: function (a) {
                    ...
                    for (t = 0; t < f; t++)
                        if (
                            ...
                            (n =
                                (g(A, !0) || b(A)) &&
                                (!c.positiveValuesOnly || A.length || 0 < A)),
                            (y =
                ...
                translate: function () {
                    ...
                    for (a = 0; a < q; a++) {
                        ...
                        b &&
                            ...
                            E &&
                            E[B] &&
                            ((v = this.getStackIndicator(v, B, this.index)),
                            (F = E[B]),
                            (C = F.points[v.key]),
                            (H = C[0]),
                            (C = C[1]),
                            H === t && v.key === E[B].base && (H = u(A, e.min)),
                            e.positiveValuesOnly && 0 >= H && (H = null),
                            (w.total = w.stackTotal = F.total),
                            (w.percentage = F.total && (w.y / F.total) * 100),
                            (w.stackY = C),
                            F.setOffset(
                                this.pointXOffset || 0,
                                this.barW || 0
                        ...
                        w.yBottom = p(H)
                            ? Math.min(
                                  Math.max(-1e5, e.translate(H, 0, 1, 0, 1)),
                                  1e5
                              )
                            : null;
                        ...
                        w.isNull ||
                            (void 0 !== D && (r = Math.min(r, Math.abs(l - D))),
                            (D = l));
                ...
                getValidPoints: function (a, b) {
                    ...
                    return k(a || this.points || [], function (a) {
                        return b &&
                            !d.isInsidePlot(a.plotX, a.plotY, d.inverted)
                            ? !1
                            : !a.isNull;
                    });
                },
                setClip: function (a) {
                    ...
                    a &&
                        !q.count[this.index] &&
                        ((q.count[this.index] = !0), (q.count.length += 1));
                    !1 !== d.clip &&
                        (this.group.clip(a || h ? q : b.clipRect),
                        this.markerGroup.clip(n),
                        (this.sharedClipKey = g));
                    a ||
                        (q.count[this.index] &&
                            (delete q.count[this.index], --q.count.length),
                        0 === q.count.length &&
                            g &&
                            b[g] &&
                            (h || (b[g] = b[g].destroy()),
                ...
                animate: function (a) {
                    ...
                    a
                        ...
                        : ((c = this.sharedClipKey),
                          (a = b[c]) &&
                              a.animate({ width: b.plotSizeX, x: 0 }, d),
                          b[c + "m"] &&
                              b[c + "m"].animate(
                    ...
                    if (!1 !== e.enabled || this._hasPointMarkers)
                        for (d = 0; d < a.length; d++)
                            (c = a[d]),
                                ...
                                (g = c.marker || {}),
                                (q = !!c.marker),
                                (f = (A && void 0 === g.enabled) || g.enabled),
                                (n = c.isInside),
                                f && !c.isNull
                                    ? ((f = u(g.symbol, this.symbol)),
                                      (y = this.markerAttribs(
                                          c,
                                          c.selected && "select"
                                      )),
                                      h
                                          ? h[n ? "show" : "hide"](!0).animate(
                                                y
                                            )
                                          : n &&
                ...
                pointAttribs: function (a, b) {
                    ...
                    b &&
                        ...
                        (c = u(
                            b.lineWidth,
                            d.lineWidth,
                            c + u(b.lineWidthPlus, d.lineWidthPlus, 0)
                        )),
                        (a = b.fillColor || d.fillColor || a),
                    ...
                    c.length &&
                        ...
                        v(c, function (c, z) {
                            ...
                            e[z]
                                ? e[z].animate(g)
                                : ((e[z] = d.clipRect(g)),
                                  q && a["zone-graph-" + z].clip(e[z]),
                                  n && a["zone-area-" + z].clip(e[z]));
                            r = c.value > A.max;
                        }),
                        (this.clips = e));
                },
                ...
                plotGroup: function (a, b, d, c, f) {
                    ...
                    h.attr({ visibility: d })[e ? "attr" : "animate"](
                        this.getPlotBox()
                    );
                    return h;
                },
    ...
    (function (a) {
        ...
        a.StackItem = function (a, c, k, b, g) {
            ...
            this.alignOptions = {
                ...
                verticalAlign:
                    c.verticalAlign || (e ? "middle" : k ? "bottom" : "top"),
                y: v(c.y, e ? 4 : k ? 14 : -6),
                x: v(c.x, e ? (k ? -6 : 6) : 0),
            };
            this.textAlign =
                c.textAlign || (e ? (k ? "right" : "left") : "center");
        };
        a.StackItem.prototype = {
            ...
            setOffset: function (a, c) {
                ...
                if ((c = this.label))
                    c.align(this.alignOptions, null, g),
                        (g = c.alignAttr),
                        c[
                            !1 === this.options.crop || b.isInsidePlot(g.x, g.y)
                                ? "show"
                                : "hide"
                        ](!0);
            },
        ...
        B.prototype.setStackedPoints = function () {
            if (
                ...
                for (G = 0; G < b; G++)
                    (h = e[G]),
                        (x = c[G]),
                        (p = this.getStackIndicator(p, h, this.index)),
                        (z = p.key),
                        (d = (J = q && x < (t ? 0 : n)) ? l : u),
                        y[d] || (y[d] = {}),
                        y[d][h] ||
                            (m[d] && m[d][h]
                                ? ((y[d][h] = m[d][h]), (y[d][h].total = null))
                                : (y[d][h] = new a.StackItem(
                                      A,
                        ...
                        (d = y[d][h]),
                        null !== x
                            ? ((d.points[z] = d.points[this.index] =
                                  [v(d.cumulative, t)]),
                              r(d.cumulative) || (d.base = z),
                              (d.touched = A.stacksTouched),
                              0 < p.index &&
                                  !1 === this.singleStacks &&
                                  (d.points[z][0] =
                                      d.points[this.index + "," + h + ",0"][0]))
                            : (d.points[z] = d.points[this.index] = null),
                        "percent" === g
                            ? ((J = J ? u : l),
                              q && y[J] && y[J][h]
                                  ? ((J = y[J][h]),
                                    (d.total = J.total =
                                        Math.max(J.total, d.total) +
                                            Math.abs(x) || 0))
                                  : (d.total = F(d.total + (Math.abs(x) || 0))))
                            : (d.total = F(d.total + (x || 0))),
                        (d.cumulative = v(d.cumulative, t) + (x || 0)),
                        null !== x &&
                            (d.points[z].push(d.cumulative),
                            (k[G] = d.cumulative));
        ...
        B.prototype.modifyStacks = function () {
            ...
            a[n + "Stacker"] &&
                l([c, "-" + c], function (c) {
                    for (var f = b.length, e, t; f--; )
                        if (
                            ((e = b[f]),
                            (g = a.getStackIndicator(g, e, a.index, c)),
                            (t = (e = k[c] && k[c][e]) && e.points[g.key]))
                        )
                            a[n + "Stacker"](t, e, f);
                });
        };
    ...
    (function (a) {
        ...
        v(a.Chart.prototype, {
            addSeries: function (a, b, c) {
                ...
                a &&
                    ((b = t(b, !0)),
                    B(d, "addSeries", { options: a }, function () {
                        f = d.initSeries(a);
                        d.isDirtyLegend = !0;
                        d.linkSeries();
                        b && d.redraw(c);
            ...
            update: function (a, b, f) {
                ...
                if (z) {
                    ...
                    "alignTicks" in z && (k = !0);
                    n(z, function (a, d) {
                        -1 !== e("chart." + d, q.propsRequireUpdateSeries) &&
                            (h = !0);
                ...
                n(a, function (a, b) {
                    if (q[b] && "function" === typeof q[b].update)
                        q[b].update(a, !1);
                    else if ("function" === typeof q[d[b]]) q[d[b]](a);
                    "chart" !== b &&
                        -1 !== e(b, q.propsRequireUpdateSeries) &&
                        (h = !0);
                });
                w(
                    ...
                    function (d) {
                        a[d] &&
                            (w(A(a[d]), function (a, b) {
                                (b = (l(a.id) && q.get(a.id)) || q[d][b]) &&
                                    b.coll === d &&
                                    (b.update(a, !1), f && (b.touched = !0));
                                if (!b && f)
                                    if ("series" === d)
                ...
                h &&
                    w(q.series, function (a) {
                        a.update({}, !1);
                    });
                a.loading && g(!0, q.options.loading, a.loading);
                k = z && z.width;
                z = z && z.height;
                (c(k) && k !== q.chartWidth) || (c(z) && z !== q.chartHeight)
                    ? q.setSize(k, z)
                    : t(b, !0) && q.redraw();
            },
        ...
        v(F.prototype, {
            update: function (a, b) {
                var c = this.chart;
                a = c.options[this.coll][this.options.index] = g(
                    this.userOptions,
                    a
                );
                this.destroy(!0);
                ...
                getStackPoints: function (l) {
                    ...
                    if (this.options.stacking) {
                        for (u = 0; u < l.length; u++)
                            (l[u].leftNull = l[u].rightNull = null),
                                (k[l[u].x] = l[u]);
                        a.objectEach(c, function (a, b) {
                ...
                drawGraph: function () {
                    ...
                    E(B, function (e) {
                        var c = e[0],
                            k = a[c];
                        k
                            ? ((k.endX = a.preventGraphAnimation
                                  ? null
                                  : l.xMap),
                              k.animate({ d: l }))
                            : ((k = a[c] =
            ...
            {},
            {
                getPointSpline: function (a, F, r) {
                    ...
                    if (
                        ...
                        e += c;
                        v > a && v > l
                            ? ((v = Math.max(a, l)), (e = 2 * l - v))
                            : v < a &&
                              v < l &&
                              ((v = Math.min(a, l)), (e = 2 * l - v));
                        e > r && e > l
                            ? ((e = Math.max(r, l)), (v = 2 * l - e))
                            : e < r &&
                              e < l &&
                              ((e = Math.min(r, l)), (v = 2 * l - e));
                        F.rightContX = B;
                        F.rightContY = e;
                    }
                    F = [
                        "C",
                        C(w.rightContX, w.plotX),
                        C(w.rightContY, w.plotY),
                        C(p, m),
                        C(v, l),
                        m,
                        l,
            ...
            },
            {
                ...
                getColumnMetrics: function () {
                    ...
                    var l = Math.min(
                        ...
                        q = (l - 2 * m) / (f || 1),
                        c = Math.min(
                            c.maxPointWidth || k.len,
                            w(c.pointWidth, q * (1 - 2 * c.pointPadding))
                        );
                    a.columnMetrics = {
                        width: c,
                        offset:
                    ...
                    F(a.points, function (b) {
                        ...
                        f &&
                            ...
                            b.y === n &&
                                ...
                                (l = !l),
                            (z =
                                Math.abs(z - t) > f ? e - f : t - (l ? f : 0)));
                        b.barX = y;
                        b.pointWidth = m;
                        b.tooltipPos = c.inverted
                            ? [
                                  g.len + g.pos - c.plotLeft - k,
                                  a.xAxis.len - y - d / 2,
                                  h,
                              ]
                            : [y + d / 2, k + g.pos - c.plotTop, h];
                        b.shapeType = "rect";
                        b.shapeArgs = a.crispCol.apply(
                            a,
                            b.isNull ? [y, t, d, 0] : [y, z, d, h]
                        );
                    });
                },
                getSymbol: a.noop,
                ...
                pointAttribs: function (a, c) {
                    ...
                    a &&
                        this.zones.length &&
                        ((t = a.getZone()),
                        (t = a.options.color || (t && t.color) || this.color));
                    c &&
                        ((a = l(
                            e.states[c],
                        ...
                        (t =
                            a.color ||
                            (void 0 !== c &&
                                E(t).brighten(a.brightness).get()) ||
                            t),
                        (f = a[b] || f),
                        (u = a[n] || u),
                        (g = a.dashStyle || g));
                    b = { fill: t, stroke: f, "stroke-width": u };
                    g && (b.dashstyle = g);
                    return b;
                },
                drawPoints: function () {
                    ...
                    F(a.points, function (e) {
                        ...
                        if (m(e.plotY) && null !== e.y) {
                            ...
                            if (f)
                                ...
                                e.graphic = f = b[e.shapeType](n).add(
                                    e.group || a.group
                                );
        ...
        c(
            ...
            },
            {
                ...
                updateTotals: function () {
                    ...
                    for (a = 0; a < k; a++)
                        (f = e[a]),
                            (c += l && !f.visible ? 0 : f.isNull ? 0 : f.y);
                    this.total = c;
                    for (a = 0; a < k; a++)
                        (f = e[a]),
                            (f.percentage =
                ...
                translate: function (a) {
                    ...
                    for (d = 0; d < z; d++) {
                        ...
                        m = (Math.cos(q) * a[2]) / 2;
                        p = (Math.sin(q) * a[2]) / 2;
                        G.tooltipPos = [a[0] + 0.7 * m, a[1] + 0.7 * p];
                        G.half = q < -Math.PI / 2 || q > Math.PI / 2 ? 1 : 0;
                        G.angle = q;
                        k = Math.min(f, G.labelDistance / 5);
                        G.labelPos = [
                            a[0] + m + Math.cos(q) * G.labelDistance,
                            a[1] + p + Math.sin(q) * G.labelDistance,
                            a[0] + m + Math.cos(q) * k,
                            a[1] + p + Math.sin(q) * k,
                            a[0] + m,
                            a[1] + p,
                ...
                drawPoints: function () {
                    ...
                    r(a.points, function (b) {
                        k = b.graphic;
                        if (b.isNull) k && (b.graphic = k.destroy());
                        else {
                            l = b.shapeArgs;
                            e = b.getTranslate();
                            var g = b.shadowGroup;
                            ...
                            k
                                ...
                                : ((b.graphic = k =
                                      c[b.shapeType](l)
                                          ...
                                          .attr(e)
                                          .add(a.group)),
                                  b.visible || k.attr({ visibility: "hidden" }),
                                  k
                                      .attr(f)
            ...
            },
            {
                ...
                setVisible: function (a, c) {
                    ...
                    a !== b.visible &&
                        ...
                        (e.options.data[w(b, e.data)] = b.options),
                        r(
                            [
                                "graphic",
                                "dataLabel",
                        ...
                        b.legendItem && f.legend.colorizeItem(b, a),
    ...
    (function (a) {
        ...
        c.prototype.drawDataLabels = function () {
            ...
            if (k.enabled || c._hasPointLabels)
                c.dlProcessOptions && c.dlProcessOptions(k),
                    (v = c.plotGroup(
                        "dataLabelsGroup",
                        "data-labels",
                        w && !y ? "hidden" : "visible",
                    ...
                    r(m, function (g) {
                        ...
                        (n = B(q && q.enabled, A.enabled) && !g.isNull) &&
                            (n = !0 === b(g, q || k));
                        n &&
                            ((k = p(A, q)),
                            (z = g.getLabelConfig()),
                            (u = k[g.formatPrefix + "Format"] || k.format),
                            (H = F(u)
                                ? l(u, z, e.time)
                                : (
                                      k[g.formatPrefix + "Formatter"] ||
                                      k.formatter
                                  ).call(z, k)),
                            (u = k.style),
                            (z = k.rotation),
                            (u.color = B(k.color, u.color, c.color, "#000000")),
                            "contrast" === u.color &&
                                ((g.contrastColor = d.getContrast(
                                    g.color || c.color
                                )),
                                (u.color =
                                    k.inside ||
                                    0 > B(g.labelDistance, k.distance) ||
                                    f.stacking
                                        ? g.contrastColor
                                        : "#000000")),
                        ...
                        !h || (n && F(H))
                            ? n &&
                              ...
                              h.attr(y),
                              h.css(u).shadow(k.shadow),
                              h.added || h.add(v),
                              c.alignDataLabel(g, h, k, null, m))
                            : ((g.dataLabel = h = h.destroy()),
                              t && (g.connector = t.destroy()));
                    });
        ...
        c.prototype.alignDataLabel = function (a, b, c, f, e) {
            var g = this.chart,
                ...
                z =
                    this.visible &&
                    (a.series.forceDL ||
                        g.isInsidePlot(k, Math.round(n), q) ||
                        (f &&
                            g.isInsidePlot(
                                k,
                                q ? f.x + 1 : f.y + f.height - 1,
                                q
                            ))),
            ...
            if (
                z &&
                ((t = c.style.fontSize),
                (t = g.renderer.fontMetrics(t, b).b),
                (f = m(
                    {
                ...
                m(c, { width: l.width, height: l.height }),
                u
                    ? ((G = !1),
                      (k = g.renderer.rotCorr(t, u)),
                      (k = {
                      ...
                      b[e ? "attr" : "animate"](k).attr({ align: d }),
                      (n = (u + 720) % 360),
                      (n = 180 < n && 360 > n),
                      "left" === d
                          ? (k.y -= n ? l.height : 0)
                          : "center" === d
                          ? ((k.x -= l.width / 2), (k.y -= l.height / 2))
                          : "right" === d &&
                            ((k.x -= l.width), (k.y -= n ? 0 : l.height)))
                    : (b.align(c, null, f), (k = b.alignAttr)),
                G
                    ...
                    : B(c.crop, !0) &&
                      (z =
                          g.isInsidePlot(k.x, k.y) &&
                          g.isInsidePlot(k.x + l.width, k.y + l.height)),
                c.shape && !u)
            )
                b[e ? "attr" : "animate"]({
        ...
        c.prototype.justifyDataLabel = function (a, b, c, f, e, k) {
            ...
            m = c.x + u;
            0 > m &&
                ("right" === n ? (b.align = "left") : (b.x = -m), (t = !0));
            m = c.x + f.width - u;
            m > g.plotWidth &&
                ("left" === n ? (b.align = "right") : (b.x = g.plotWidth - m),
                (t = !0));
            m = c.y + u;
            0 > m &&
                ("bottom" === l ? (b.verticalAlign = "top") : (b.y = -m),
                (t = !0));
            m = c.y + f.height - u;
            m > g.plotHeight &&
                ("top" === l
        ...
        k.pie &&
            ((k.pie.prototype.drawDataLabels = function () {
                ...
                b.visible &&
                    ...
                    r(e, function (a) {
                        a.dataLabel &&
                            a.visible &&
                            (N[a.half].push(a), (a.dataLabel._pos = null));
                    }),
                    r(N, function (c, e) {
                        var g,
                            q,
                        ...
                        if (n)
                            for (
                                ...
                                (k = c[Q]),
                                    ...
                                    (O = l.justify
                                        ? v[0] +
                                          (e ? -1 : 1) * (w + k.labelDistance)
                                        : b.getX(
                                              C < k.top + 2 || C > k.bottom - 2
                                                  ? g
                                                  : C,
                                              e,
                                              k
                                          )),
                                    (z._attr = { visibility: M, align: h[6] }),
                                    (z._pos = {
                                        x:
                                            O +
                                            l.x +
                                            ({ left: m, right: -m }[h[6]] || 0),
                                        y: C + l.y - 10,
                                    }),
                                    (h.x = O),
                                    (h.y = C),
                    ...
                    0 === E(K) || this.verifyDataLabelOverflow(K)) &&
            ...
            (k.pie.prototype.connectorPath = function (a) {
                var b = a.x,
                    c = a.y;
                return B(this.options.dataLabels.softConnector, !0)
                    ? [
                          "M",
                          b + ("left" === a[6] ? 5 : -5),
                          c,
            ...
            (k.pie.prototype.alignDataLabel = v),
            (k.pie.prototype.verifyDataLabelOverflow = function (a) {
                ...
                q ||
                    (null !== f[0]
                        ? (k = Math.max(b[2] - Math.max(a[1], a[3]), g))
                        : ((k = Math.max(b[2] - a[1] - a[3], g)),
                          (b[0] += (a[3] - a[1]) / 2)),
                    null !== f[1]
                        ? (k = Math.max(
                        ...
                        : ((k = Math.max(Math.min(k, b[2] - a[0] - a[2]), g)),
                          (b[1] += (a[0] - a[2]) / 2)),
                    k < b[2]
                        ? ((b[2] = k),
        ...
        k.column &&
            (k.column.prototype.alignDataLabel = function (a, b, e, f, k) {
                var g = this.chart.inverted,
                    q = a.series,
                    l = a.dlBox || a.shapeArgs,
                    n = B(
                        a.below,
                        a.plotY > B(this.translatedThreshold, q.yAxis.len)
                    ),
                    m = B(e.inside, !!this.options.stacking);
                l &&
                    ((f = p(l)),
                    0 > f.y && ((f.height += f.y), (f.y = 0)),
                    (l = f.y + f.height - q.yAxis.len),
                    0 < l && (f.height -= l),
                    g &&
                        (f = {
    ...
    (function (a) {
        ...
        a(C.prototype, "render", function () {
            ...
            E(this.yAxis || [], function (l) {
                l.options.stackLabels &&
                    !l.options.stackLabels.allowOverlap &&
                    F(l.stacks, function (l) {
                        F(l, function (l) {
                            a.push(l.label);
                        });
                    });
                    ...
                    E(p, function (m) {
                        E(l.points, function (l) {
                            l[m] &&
                                ((l[m].labelrank = r(
                                    l.labelrank,
                                    l.shapeArgs && l.shapeArgs.height
                                )),
                                a.push(l[m]));
                        });
                    });
        ...
        D = a.TrackerMixin = {
                ...
                a._hasTracking ||
                    (w(a.trackerGroups, function (f) {
                        if (a[f]) {
                            ...
                            a.options.cursor &&
                                a[f].css(r).css({ cursor: a.options.cursor });
                        }
                    }),
                    (a._hasTracking = !0));
            ...
            drawTrackerGraph: function () {
                var a = this,
                    ...
                    t = "rgba(192,192,192," + (u ? 0.0001 : 0.002) + ")";
                if (e && !c)
                    for (n = e + 1; n--; )
                        "M" === f[n] &&
                            f.splice(n + 1, 0, f[n + 1] - l, f[n + 2], "L"),
                            ((n && "M" === f[n]) || n === e) &&
                                f.splice(n, 0, "L", f[n - 2] + l, f[n - 1]);
                h
                    ? h.attr({ d: f })
                    : a.graph &&
                      ((a.tracker = k
                          ...
                          .add(a.group)),
                      w([a.tracker, a.markerGroup], function (a) {
            ...
            showResetZoom: function () {
                ...
                v(this, "beforeShowResetZoom", null, function () {
                    b.resetZoomButton = b.renderer
                        .button(c.resetZoom, null, null, a, e, g && g.hover)
                        .attr({
            ...
            zoom: function (a) {
                ...
                !a || a.resetSelection
                    ? (w(this.axes, function (a) {
                      ...
                      (f.initiated = !1))
                    : w(a.xAxis.concat(a.yAxis), function (a) {
                          var d = a.axis;
                          f[d.isXAxis ? "zoomX" : "zoomY"] &&
                ...
                e && !k
                    ? this.showResetZoom()
                    : !e && c(k) && (this.resetZoomButton = k.destroy());
                b &&
                    this.redraw(
                        g(
            ...
            pan: function (a, b) {
                ...
                w("xy" === b ? [1, 0] : [1], function (b) {
                    ...
                    b.series.length &&
                        g !== k.min &&
                        q !== k.max &&
                        (b.setExtremes(g, q, !1, !1, { trigger: "pan" }),
                        (e = !0));
                    c[d] = f;
                });
                e && c.redraw(!1);
            ...
            select: function (a, b) {
                ...
                c.firePointEvent(
                    ...
                    function () {
                        ...
                        c.setState(a && "select");
                        b ||
                            w(k.getSelectedPoints(), function (a) {
                                a.selected &&
                                    a !== c &&
                    ...
                    if (this.graphic)
                        this.state &&
                            ...
                            this.graphic.animate(
                                ...
                                g(t.options.chart.animation, k.animation)
                            ),
                            D &&
                                this.graphic.animate(
                                    D,
                        ...
                        if (a && n) {
                            ...
                            if (m)
                                m[b ? "animate" : "attr"]({ x: D.x, y: D.y });
                            else
                                d &&
                                    ((e.stateMarkerGraphic = m =
                                        t.renderer
                                            .symbol(
                                                d,
                                                D.x,
                        ...
                        m &&
                            (m[
                                a && t.isInsidePlot(c, f, t.inverted)
                                    ? "show"
                                    : "hide"
                            ](),
                        ...
                        ? (u ||
                          ...
                          u.attr({
                              class:
                                  ...
                                  g(this.colorIndex, e.colorIndex),
                          }),
                          (u.point = this),
                          u.attr(
                              p(
        ...
        p(t.prototype, {
            ...
            setState: function (a) {
                ...
                if (
                    ...
                    (b.state = a),
                    !e[a] || !1 !== e[a].enabled) &&
                    (a && (k = e[a].lineWidth || k + (e[a].lineWidthPlus || 0)),
                    f && !f.dashstyle)
                )
                    for (
                        k = { "stroke-width": k },
            ...
            setVisible: function (a, b) {
                ...
                if (
                    f.hoverSeries === c ||
                    (f.hoverPoint && f.hoverPoint.series) === c
                )
                    c.onMouseOut();
    ...
    (function (a) {
        ...
        C.prototype.matchResponsiveRule = function (a, m) {
            ...
            (
                ...
                function () {
                    return (
                        this.chartWidth <= l(p.maxWidth, Number.MAX_VALUE) &&
                        this.chartHeight <= l(p.maxHeight, Number.MAX_VALUE) &&
                        this.chartWidth >= l(p.minWidth, 0) &&
                        this.chartHeight >= l(p.minHeight, 0)
                    );
                }
    ...
    (function (a) {
        ...
        e(E.prototype, "getTimeTicks", function (a, e, b, g, l, t, f, u) {
            ...
            if (u && a.unitRange <= B.hour) {
                k = d.length - 1;
                for (c = 1; c < k; c++)
                    h.dateFormat("%d", d[c]) !== h.dateFormat("%d", d[c - 1]) &&
                        ((y[d[c]] = "day"), (p = !0));
                p && (y[d[0]] = "day");
                a.higherRanks = y;
            }
        ...
        w(E.prototype, {
                ...
                if (n || p) {
                    l(this.series, function (b, c) {
                        if (
                            !(
                                (A && !1 === b.visible) ||
                                (!1 === b.takeOrdinalPosition && !p)
                            ) &&
                            ((e = e.concat(b.processedXData)),
                            (a = e.length),
                            e.sort(function (a, b) {
                                return a - b;
                            }),
                            (q = Math.min(q, v(b.closestPointRange, q))),
                            a)
                        )
                            for (c = a - 1; c--; )
                    ...
                    if (2 < a) {
                        ...
                        this.options.overscroll &&
                            (2 === a
                                ? (q = e[1] - e[0])
                                : 1 === a
                                ? ((q = this.options.overscroll),
                                  (e = [e[0], e[0] + q]))
                                : (q = this.overscrollPointsRange));
                    b
                        ? (this.options.overscroll &&
                              ((this.overscrollPointsRange = q),
                              (e = e.concat(this.getOverscrollPositions()))),
                          (this.ordinalPositions = e),
                          (g = this.ordinal2lin(Math.max(t, e[0]), !0)),
                          (u = Math.max(
                              this.ordinal2lin(
                                  Math.min(f, e[e.length - 1]),
                                  !0
                              ),
                              1
                          )),
                          (this.ordinalSlope = f = (f - t) / (u - g)),
                          (this.ordinalOffset = t - g * f))
                        : ((this.overscrollPointsRange = v(
                              this.closestPointRange,
            ...
            getExtendedPositions: function () {
                ...
                g[n] ||
                    ...
                    a.beforeSetTickPositions.apply(u),
                    (g[n] = u.ordinalPositions));
                return g[n];
            },
            ...
            if (b.options.ordinal && b.series.length) {
                ...
                w.ordinalPositions
                    ? 1 < Math.abs(f) &&
                      ...
                      0 > f
                          ? ((y = w), (d = b.ordinalPositions ? b : w))
                          : ((y = b.ordinalPositions ? b : w), (d = w)),
                      (w = d.ordinalPositions),
                      p > w[w.length - 1] && w.push(p),
                      (this.fixedRange = A - q),
                      (f = b.toFixedRange(
                          null,
                          null,
                          v.apply(y, [B.apply(y, [q, !0]) + f, !0]),
                          v.apply(d, [B.apply(d, [A, !0]) + f, !0])
                      )),
                      f.min >= Math.min(u.dataMin, q) &&
                          f.max <= Math.max(p, A) + c &&
                          b.setExtremes(f.min, f.max, !0, !1, {
                              trigger: "pan",
                          }),
                      (this.mouseDownX = k),
                      r(this.container, { cursor: "move" }))
                    : (m = !0);
            } else m = !0;
            m &&
                (c && (b.max = b.dataMax + c),
    ...
    (function (a) {
        ...
        r(v.prototype, "init", function (a, c, k) {
            ...
            b.isBroken &&
                ((b.val2lin = function (a) {
                    var c = a,
                        e,
                        f;
                    for (f = 0; f < b.breakArray.length; f++)
                        if (((e = b.breakArray[f]), e.to <= a)) c -= e.len;
                ...
                (b.lin2val = function (a) {
                    ...
                    for (
                        e = 0;
                        e < b.breakArray.length &&
                        !((c = b.breakArray[e]), c.from >= a);
                        e++
                    )
                        c.to < a
                            ? (a += c.len)
                            : b.isInBreak(c, a) && (a += c.len);
                    return a;
                }),
                ...
                (b.setAxisTranslation = function (a) {
                    ...
                    p(b, "afterBreaks");
                    b.options.staticScale
                        ? (b.transA = b.options.staticScale)
                        : b.unitLength &&
                          (b.transA *= (A - b.min + y) / b.unitLength);
            ...
            if (c && e && (c.options.breaks || e.options.breaks))
                for (; l--; )
                    (g = b[l]),
                        (f = null === g.y && !1 === m),
                        f ||
                            (!c.isInAnyBreak(g.x, !0) &&
                                !e.isInAnyBreak(g.y, !0)) ||
                            (b.splice(l, 1),
                    ...
                    m(b, function (b) {
                        ...
                        m(g, function (c) {
                            ...
                            if (
                                ...
                                (l < c.from && f > c.from && f < c.to) ||
                                (l > c.from && f > c.to && f < c.from)
                            )
                                t = "pointInBreak";
        ...
        a.Series.prototype.gappedPath = function () {
            ...
            if (e && 0 < b)
                for (
                    ...
                    k[b + 1].x - k[b].x > e &&
                        ((c = (k[b].x + k[b + 1].x) / 2),
                        k.splice(b + 1, 0, { isNull: !0, x: c }),
                        this.options.stacking &&
                            ((c = g.stacks[this.stackKey][c] =
                                new a.StackItem(
                                    g,
    ...
    (function (a) {
        ...
        g.groupData = function (a, b, c, e) {
            ...
            e =
                "function" === typeof e
                    ? e
                    : q[e] ||
                      (u[this.type] && q[u[this.type].approximation]) ||
                      q[f.approximation];
            ...
            for (H; H <= n; H++) {
                for (; (void 0 !== c[w + 1] && a[H] >= c[w + 1]) || H === n; ) {
                    ...
                    y = e.apply(this, t);
                    void 0 !== y &&
                        (k.push(A), m.push(y), h.push(this.dataGroupInfo));
                    y = H;
                    for (A = 0; A < B; A++)
                ...
                if (r) {
                    ...
                    for (A = 0; A < D; A++)
                        (C = I[r[A]]),
                            v(C)
                                ? t[A].push(C)
                                : null === C && (t[A].hasNulls = !0);
                } else
                    (A = p ? b[H] : null),
                        v(A)
                            ? t[0].push(A)
                            : null === A && (t[0].hasNulls = !0);
            }
            return [k, m, h];
        };
        g.processData = function () {
            ...
            if (!1 !== n.apply(this, arguments) && c) {
                ...
                if (t) {
                    ...
                    t = ((t * (c - l)) / u) * p;
                    u = a.getTimeTicks(
                        a.normalizeTimeTickInterval(t, b.units || D),
                        Math.min(l, q[0]),
                        Math.max(c, q[q.length - 1]),
        ...
        b(k.prototype, "tooltipFooterHeaderFormatter", function (a, b, c) {
            var f = this.chart.time,
                ...
                h,
                l = e.xAxis;
            return l && "datetime" === l.options.type && g && v(b.key)
                ? ((a = e.currentDataGrouping),
                  (g = g.dateTimeLabelFormats),
                  a
                      ? ((l = g[a.unitName]),
                        1 === a.count ? (k = l[0]) : ((k = l[1]), (h = l[2])))
                      : !k && g && (k = this.getXDateFormat(b, d, l)),
                  (k = f.dateFormat(k, b.key)),
                  h && (k += f.dateFormat(h, b.key + a.totalRange - 1)),
                  p(
                      d[(c ? "footer" : "header") + "Format"],
                      { point: w(b.point, { key: k }), series: e },
                      f
                  ))
                : a.call(this, b, c);
        });
        ...
        F.prototype.getGroupPixelWidth = function () {
            var a = this.series,
                ...
                d;
            for (c = b; c--; )
                (d = a[c].options.dataGrouping) &&
                    (f = Math.max(f, d.groupPixelWidth));
            for (c = b; c--; )
                (d = a[c].options.dataGrouping) &&
                    a[c].hasProcessed &&
    ...
    (function (a) {
        ...
        F(
            ...
            },
            {
                ...
                translate: function () {
                    ...
                    C(a.points, function (m) {
                        C(
                            [m.open, m.high, m.low, m.close, m.low],
                            function (r, e) {
                                null !== r &&
                                    (w && (r = a.modifyValue(r)),
                                    (m[p[e]] = l.toPixels(r, !0)));
                            }
                        );
                ...
                drawPoints: function () {
                    ...
                    C(a.points, function (m) {
                        ...
                        void 0 !== m.plotY &&
                            (c ||
                                (m.graphic = c =
                                    l.renderer.path().add(a.group)),
                            c.attr(a.pointAttribs(m, m.selected && "select")),
                            (r = (c.strokeWidth() % 2) / 2),
                            (k = Math.round(m.plotX) - r),
                            (w = Math.round(m.shapeArgs.width / 2)),
                            (e = [
                                "M",
                                k,
                                Math.round(m.yBottom),
                                "L",
                                k,
                                Math.round(m.plotHigh),
                            ]),
                            null !== m.open &&
                                ((p = Math.round(m.plotOpen) + r),
                                e.push("M", k, p, "L", k - w, p)),
                            null !== m.close &&
                                ((p = Math.round(m.plotClose) + r),
                                e.push("M", k, p, "L", k + w, p)),
                            c[b ? "attr" : "animate"]({ d: e }).addClass(
                                m.getClassName(),
                                !0
                            ));
                    });
            ...
            },
            {
                getClassName: function () {
                    return (
                        E.prototype.getClassName.call(this) +
        ...
        r(
            ...
            }),
            {
                pointAttribs: function (a, r) {
                    ...
                    l.fill =
                        a.options.color ||
                        (w ? v.upColor || this.color : this.color);
                    l.stroke = a.lineColor || (w ? v.upLineColor || e : e);
                    r &&
                        ((a = v.states[r]),
                        (l.fill = a.color || l.fill),
                        (l.stroke = a.lineColor || l.stroke),
                        (l["stroke-width"] = a.lineWidth || l["stroke-width"]));
                    return l;
                },
                drawPoints: function () {
                    var a = this,
                    ...
                    E(a.points, function (l) {
                        ...
                        void 0 !== l.plotY &&
                            (p ||
                                (l.graphic = p =
                                    m.renderer.path().add(a.group)),
                            p
                                .attr(a.pointAttribs(l, l.selected && "select"))
                                .shadow(a.options.shadow),
                            (b = (p.strokeWidth() % 2) / 2),
                            (g = Math.round(l.plotX) - b),
                            (r = l.plotOpen),
                            (e = l.plotClose),
                            (c = Math.min(r, e)),
                            (r = Math.max(r, e)),
                            (n = Math.round(l.shapeArgs.width / 2)),
                            (e = Math.round(c) !== Math.round(l.plotHigh)),
                            (k = r !== l.yBottom),
                            (c = Math.round(c) + b),
                            (r = Math.round(r) + b),
                            (b = []),
                            b.push(
                                ...
                                "L",
                                g,
                                e ? Math.round(l.plotHigh) : c,
                                "M",
                                g,
                                r,
                                "L",
                                g,
                                k ? Math.round(l.yBottom) : r
                            ),
                            p[t ? "attr" : "animate"]({ d: b }).addClass(
                                l.getClassName(),
                                !0
                            ));
                    });
    ...
    da = (function (a) {
        ...
        return {
            ...
            translate: function () {
                ...
                if (p && p.visible && c)
                    for (
                        g = (p.pointXOffset || 0) + (p.barW || 0) / 2,
                            p = p.currentDataGrouping,
                            t = e[c - 1].x + (p ? p.totalRange : 0),
                            F(l, function (a, b) {
                                return a.x - b.x;
                            }),
                ...
                C(l, function (a, c) {
                    ...
                    a.plotX += g;
                    void 0 === a.plotY &&
                        (0 <= a.plotX && a.plotX <= k.len
                            ? (a.plotY =
                                  m.chartHeight -
                                  k.bottom -
                                  (k.opposite ? k.height : 0) +
                                  k.offset -
                                  b.top)
                            : (a.shapeArgs = {}));
                    (v = l[c - 1]) &&
                        v.plotX === a.plotX &&
                        (void 0 === v.stackIndex && (v.stackIndex = 0),
                        (f = v.stackIndex + 1));
                    a.stackIndex = f;
                });
            },
    ...
    (function (a, C) {
        function E(a) {
            e[a + "pin"] = function (c, b, g, l, m) {
                ...
                "circle" === a &&
                    l > g &&
                    ((c -= Math.round((l - g) / 2)), (g = l));
                c = e[a](c, b, g, l);
                f &&
                    m &&
                    (c.push(
                        "M",
                        "circle" === a ? c[1] - c[4] : c[1] + c[4] / 2,
                        b > m ? b : b + l,
                        "L",
                        f,
                        m
                    ),
                    (c = c.concat(e.circle(f - 1, m - 1, 2, 2))));
                return c;
            };
        }
        var F = a.addEvent,
        ...
        p(
            ...
            "column",
            {
                ...
                lineWidth: 1,
                states: {
                    hover: { lineColor: "#000000", fillColor: "#ccd6eb" },
                },
            ...
            },
            {
                ...
                pointAttribs: function (a, e) {
                    ...
                    e &&
                        ((a = b.states[e].fillColor),
                        (k = b.states[e].lineColor),
                        (l = b.states[e].lineWidth));
                    return {
                        fill: a || c,
                        stroke: k || c,
                ...
                drawPoints: function () {
                    ...
                    for (p = c.length; p--; )
                        (q = c[p]),
                            (v = q.plotX > this.xAxis.len),
                            (g = q.plotX),
                            (A = q.stackIndex),
                            (u = q.options.shape || t.shape),
                            (l = q.plotY),
                            void 0 !== l &&
                                (l =
                                    q.plotY +
                                    f -
                                    (void 0 !== A && A * t.stackDistance)),
                            (q.anchorX = A ? void 0 : q.plotX),
                            (y = A ? void 0 : q.plotY),
                            (A = q.graphic),
                            void 0 !== l && 0 <= g && !v
                                ? (A ||
                                      ...
                                      q.graphic.div &&
                                          (q.graphic.div.point = q),
                                      A.shadow(t.shadow),
                                      (A.isNew = !0)),
                                  0 < g && (g -= A.strokeWidth() % 2),
                                  (u = { y: l, anchorY: y }),
                                  t.allowOverlapX &&
                                      ((u.x = g), (u.anchorX = q.anchorX)),
                                  A.attr({
                                      text: q.options.title || t.title || "A",
                                  })[A.isNew ? "attr" : "animate"](u),
                                  t.allowOverlapX ||
                                      (B[q.plotX]
                                          ? (B[q.plotX].size = Math.max(
                                                B[q.plotX].size,
                                                A.width
                                            ))
                                          : (B[q.plotX] = {
                                  ...
                                  (q.tooltipPos = e.inverted
                                      ? [
                                            w.len + w.pos - e.plotLeft - l,
                                            this.xAxis.len - g,
                                        ]
                                      : [g, l + w.pos - e.plotTop]))
                    ...
                    t.allowOverlapX ||
                        ...
                        a.distribute(d, this.xAxis.len),
                        r(c, function (a) {
                            var b = a.graphic && B[a.plotX];
                            b &&
                                (a.graphic[
                                    a.graphic.isNew ? "attr" : "animate"
                                ]({ x: b.pos, anchorX: a.anchorX }),
                                (a.graphic.isNew = !1));
                        }));
                    t.useHTML &&
                ...
                drawTracker: function () {
                    ...
                    r(a, function (c) {
                        var b = c.graphic;
                        b &&
                            F(b.element, "mouseover", function () {
                                0 < c.stackIndex &&
                                    !c.raised &&
                                    ((c._y = b.y),
                                    b.attr({ y: c._y - 8 }),
        ...
        E("square");
        w === B &&
            r(["flag", "circlepin", "squarepin"], function (a) {
    ...
    (function (a) {
        ...
        C.prototype = {
            ...
            render: function () {
                ...
                this.scrollbar = a
                    ...
                    .attr({ height: c, width: c, r: b.barBorderRadius || 0 })
            ...
            position: function (a, b, c, e) {
                ...
                this.yOffset = g;
                f
                    ? ((this.width = this.yOffset = c = g = this.size),
                      (this.xOffset = b = 0),
                      (this.barWidth = e - 2 * c),
            ...
            setRange: function (a, b) {
                ...
                l(g) &&
                    ((a = Math.max(a, 0)),
                    (k = Math.ceil(g * a)),
                    (this.calculatedWidth = m = r(g * Math.min(b, 1) - k)),
                    m < e && ((k = (g - e + m) * a), (m = e)),
                    ...
                    (this.to = b),
                    f
                        ? (this.scrollbarGroup[n]({ translateY: e }),
                          this.scrollbar[n]({ height: m }),
                          this.scrollbarRifles[n]({ translateY: g }),
                          (this.scrollbarTop = e),
                          (this.scrollbarLeft = 0))
                        : (this.scrollbarGroup[n]({ translateX: e }),
                          this.scrollbar[n]({ width: m }),
                          this.scrollbarRifles[n]({ translateX: g }),
            ...
            initEvents: function () {
                ...
                a.mouseMoveHandler = function (b) {
                    var c = a.chart.pointer.normalize(b),
                        ...
                        e = a.initPositions;
                    !a.grabbedCenter ||
                        (b.touches && 0 === b.touches[0][f]) ||
                        ((c = a.cursorToScrollbarPosition(c)[f]),
                        (f = a[f]),
                        (f = c - f),
                        (a.hasDragged = !0),
                        a.updatePosition(e[0] + f, e[1] + f),
                        a.hasDragged &&
                            v(a, "changed", {
                                from: a.from,
                                to: a.to,
                ...
                a.trackClick = function (b) {
                    ...
                    (a.options.vertical && c.chartY > e) ||
                    (!a.options.vertical && c.chartX > g)
                        ? a.updatePosition(a.from + f, a.to + f)
                        : a.updatePosition(a.from - f, a.to - f);
                    v(a, "changed", {
                        from: a.from,
                        to: a.to,
            ...
            addEvents: function () {
                var a = this.options.inverted ? [1, 0] : [0, 1],
                    ...
                    a = [
                        ...
                        [c.ownerDocument, "mouseup", k],
                    ];
                B &&
                    a.push(
                        [c, "touchstart", e],
                        [c.ownerDocument, "touchmove", g],
                        [c.ownerDocument, "touchend", k]
                    );
                p(a, function (a) {
                    E.apply(null, a);
                });
            ...
            destroy: function () {
                ...
                a &&
                    this === a.scrollbar &&
                    ((a.scrollbar = null), w(a.scrollbarButtons));
            },
        };
        ...
        g(F.prototype, "render", function (a) {
            var b = Math.min(
                    k(this.options.min, this.min),
                    this.min,
                    k(this.dataMin, this.min)
                ),
                c = Math.max(
                    k(this.options.max, this.max),
                    this.max,
                    k(this.dataMax, this.max)
                ),
                f = this.scrollbar,
            ...
            if (f) {
                this.horiz
                    ? (f.position(
                          ...
                          this.top +
                              ...
                              (this.opposite
                                  ? 0
                                  : e + this.axisTitleMargin + this.offset),
                          this.width,
                          this.height
                      ),
                      (e = 1))
                ...
                if (
                    ...
                    this.chart.scrollbarsOffsets[e] +=
                        this.scrollbar.size + this.scrollbar.options.margin;
                isNaN(b) || isNaN(c) || !l(this.min) || !l(this.max)
                    ? f.setRange(0, 0)
                    : ((e = (this.min - b) / (c - b)),
                      (b = (this.max - b) / (c - b)),
    ...
    (function (a) {
        ...
        c(l, {
            navigator: {
                ...
                maskFill: m("#6685c2").setOpacity(0.3).get(),
                outlineColor: "#cccccc",
                outlineWidth: 1,
                series: {
                    type: y,
        ...
        C.prototype = {
            ...
            render: function (b, c, e, f) {
                ...
                if (!this.hasDragged || w(e)) {
                    if (!n(b) || !n(c))
                        if (p) (e = 0), (f = u(m.width, h.width));
                        else return;
                    this.left = u(
                        m.left,
                        d.plotLeft + k + (g ? d.plotWidth : 0)
                    );
                    this.size =
                        z =
                        l =
                            u(m.len, (g ? d.plotHeight : d.plotWidth) - 2 * k);
                    d = g ? k : l + 2 * k;
                    ...
                    t < r
                        ? this.grabbedLeft
                            ? (e = m.toPixels(c - r, !0))
                            : this.grabbedRight && (f = m.toPixels(b + r, !0))
                        : w(y) &&
                          t > y &&
                          (this.grabbedLeft
                              ? (e = m.toPixels(c - y, !0))
                    ...
                    q &&
                        ...
                        this.drawMasks(e, z, g, p),
                        this.drawOutline(e, z, g, p),
                        this.navigatorOptions.handles.enabled &&
                            (this.drawHandle(e, 0, g, p),
                            this.drawHandle(z, 1, g, p)));
                    this.scrollbar &&
                        (g
                            ? ((g = this.top - k),
                              (h =
                                  ...
                                  (q || !h.opposite
                                      ...
                                      : (h.titleOffset || 0) +
                                        h.axisTitleMargin)),
                              (k = l + 2 * k))
                            : ((g = this.top + (q ? this.height : -k)),
                              (h = this.left - k)),
                        this.scrollbar.position(h, g, d, k),
            ...
            addMouseEvents: function () {
                ...
                a.series &&
                    a.series[0] &&
                    f.push(
                        E(a.series[0].xAxis, "foundExtremes", function () {
                    ...
                    : ((a = l - f - k / 2),
                      0 === b
                          ...
                          : 2 === b &&
                            ...
                            d.reversed
                                ? ((a -= k),
                                  (n = this.getUnionExtremes().dataMin))
                                : (m = this.getUnionExtremes().dataMax)),
                      a !== e &&
                          ((this.fixedWidth = k),
                          (b = d.toFixedRange(a, a + k, n, m)),
                          w(b.min) &&
            ...
            onMouseMove: function (a) {
                ...
                (a.touches && 0 === a.touches[0].pageX) ||
                    ...
                    (c = a.chartX),
                    k && ((d = b.top), (c = a.chartY)),
                    b.grabbedLeft
                        ? ((b.hasDragged = !0),
                          b.render(0, 0, c - d, b.otherHandlePos))
                        : b.grabbedRight
                        ? ((b.hasDragged = !0),
                          b.render(0, 0, b.otherHandlePos, c - d))
                        : b.grabbedCenter &&
                          ((b.hasDragged = !0),
            ...
            onMouseUp: function (a) {
                ...
                ((!this.hasDragged || (e && e.hasDragged)) &&
                    ...
                    this.zoomedMax === this.size &&
                        (g = d ? e.dataMin : e.dataMax),
                    0 === this.zoomedMin && (f = d ? e.dataMax : e.dataMin),
            ...
            removeEvents: function () {
                this.eventsToUnbind &&
                    (v(this.eventsToUnbind, function (a) {
                        a();
                    }),
            ...
            init: function (a) {
                ...
                l.navigatorEnabled
                    ? ((l.xAxis = new F(
                          ...
                          f(
                              ...
                              a.inverted
                                  ? { offsets: [k, 0, -k, 0], width: b }
                                  : { offsets: [0, -k, 0, k], height: b }
                          )
                      )),
                      (l.yAxis = new F(
                          a,
                ...
                a.options.scrollbar.enabled &&
                    ((a.scrollbar = l.scrollbar =
                        new q(
                            a.renderer,
                            f(a.options.scrollbar, {
                                margin: l.navigatorEnabled ? 0 : 10,
                                vertical: a.inverted,
                            }),
                            a
                        )),
                    E(l.scrollbar, "changed", function (b) {
                        var c = l.size,
                            d = c * this.to,
                            c = c * this.from;
            ...
            getUnionExtremes: function (a) {
                ...
                (a && null === b.dataMin) ||
                    (f = {
                        dataMin: u(
                            d && d.min,
                            J("min", e.min, b.dataMin, c.dataMin, c.min)
                        ),
                        dataMax: u(
                            d && d.max,
                            J("max", e.max, b.dataMax, c.dataMax, c.max)
                        ),
                    });
                return f;
            },
            ...
            updateNavigatorSeries: function (b) {
                var d = this,
                    ...
                    t = (d.series = a.grep(d.series || [], function (b) {
                        var c = b.baseSeries;
                        return 0 > a.inArray(c, h)
                            ? (c &&
                                  (D(c, "updatedData", d.updatedDataHandler),
                ...
                h &&
                    ...
                    v(h, function (a) {
                        var z = a.navigatorSeries,
                            r = c(
                                { color: a.color },
                                g(n) ? l.navigator.series : n
                            );
                        (z && !1 === d.navigatorOptions.adaptToUpdatedData) ||
                            ((p.name = "Navigator " + h.length),
                            (k = a.options || {}),
                            (q = k.navigatorOptions || {}),
                            (m = f(k, p, r, q)),
                            (r = q.data || r.data),
                            (d.hasNavigatorData = d.hasNavigatorData || !!r),
                            (m.data = r || (k.data && k.data.slice(0))),
                            z && z.options
                                ? z.update(m, b)
                                : ((a.navigatorSeries = e.initSeries(m)),
                                  (a.navigatorSeries.baseSeries = a),
                                  t.push(a.navigatorSeries)));
                    });
                if ((n.data && (!h || !h.length)) || g(n))
                    (d.hasNavigatorData = !1),
                        (n = a.splat(n)),
                        v(n, function (a, b) {
                            ...
                            m.data = a.data;
                            m.data &&
                                ((d.hasNavigatorData = !0),
                                t.push(e.initSeries(m)));
                        });
            ...
            addBaseSeriesEvents: function () {
                ...
                b[0] &&
                    b[0].xAxis &&
                    E(b[0].xAxis, "foundExtremes", this.modifyBaseAxisExtremes);
                v(
                    b,
                    function (b) {
                        E(b, "show", function () {
                        ...
                        !1 !== this.navigatorOptions.adaptToUpdatedData &&
                            b.xAxis &&
                            E(b, "updatedData", this.updatedDataHandler);
                        E(b, "remove", function () {
                            this.navigatorSeries &&
                                (B(a.series, this.navigatorSeries),
                ...
                (this.eventArgs &&
                    ...
                    g &&
                        ...
                        f ||
                            (m = Math.max(
                                l - b,
                                q && q.xData ? q.xData[0] : -Number.MAX_VALUE
                            ))),
                    p &&
                        (f || g) &&
                        n(m) &&
    ...
    (function (a) {
        ...
        C.prototype = {
            clickButton: function (a, c) {
                var g = this,
                    ...
                    m = k.xAxis[0],
                    q =
                        (k.scroller && k.scroller.getUnionExtremes()) ||
                        m ||
                        {},
                    d = q.dataMin,
                    p = q.dataMax,
                ...
                if (null !== d && null !== p) {
                    ...
                    if ("month" === r || "year" === r)
                        m
                            ? ((r = {
                              ...
                              (t = m.minFromRange.call(r)),
                              b(r.newMax) && (h = r.newMax))
                            : (q = l);
                    else if (q)
                        ...
                        if (m)
                            void 0 === p &&
                                ...
                                (c = !1)),
                                (h = g.getYTDExtremes(p, d, k.time.useUTC)),
                                (t = v = h.min),
                                (h = h.max);
                        else {
                    ...
                    g.setSelected(a);
                    m
                        ? m.setExtremes(t, h, n(c, 1), null, {
                              trigger: "rangeSelectorButton",
                              rangeSelectorButton: l,
                          })
                        : ((u = f(k.options.xAxis)[0]),
                          (D = u.range),
                          (u.range = q),
                          (w = u.min),
                          (u.min = v),
            ...
            updateButtonStates: function () {
                ...
                e(this.buttonOptions, function (a, b) {
                    ...
                    var u = e > m - l,
                        ...
                        e = e === f;
                    ("month" === k || "year" === k) &&
                    f + 36e5 >= 864e5 * { month: 28, year: 365 }[k] * q - a &&
                    f - 36e5 <= 864e5 * { month: 31, year: 366 }[k] * q + a
                        ? (e = !0)
                        : "ytd" === k
                        ? ((e = n - d + a === f), (v = !b))
                        : "all" === k &&
                          ((e = c.max - c.min >= m - l), (x = !b && h && e));
                    k = !t && (u || z || x || g);
                    q = (b && e) || (e && !h && !v);
                    k ? (A = 3) : q && ((h = !0), (A = 2));
            ...
            setInputValue: function (a, b) {
                ...
                f.value = e.dateFormat(
                    c.inputEditDateFormat || "%Y-%m-%d",
                    f.HCTime
                );
                this[a + "DateBox"].attr({
                    text: e.dateFormat(
                        c.inputDateFormat || "%b %e, %Y",
                        f.HCTime
                    ),
                });
            },
            ...
            drawInput: function (a) {
                function e() {
                    ...
                    c !== v.previousValue &&
                        ...
                        b(c) ||
                            ((c = a.split("-")),
                            (c = Date.UTC(t(c[0]), t(c[1]) - 1, t(c[2])))),
                        b(c) &&
                            (k.time.useUTC ||
                ...
                this[a + "Label"] = h = p
                    .label(
                        w.lang[u ? "rangeSelectorFrom" : "rangeSelectorTo"],
            ...
            render: function (a, b) {
                ...
                if (!1 !== h.enabled) {
                    L ||
                        ((c.group = L =
                            g
                                ...
                                .add()),
                        (c.buttonGroup = E =
                            g.g("range-selector-buttons").add(L)),
                        (c.zoomText = g
                            .text(q.rangeSelectorZoom, n(C + u.x, C), 15)
                            .css(h.labelStyle)
                            .add(E)),
                        (F = n(C + u.x, C) + c.zoomText.getBBox().width + 5),
                        e(c.buttonOptions, function (a, b) {
                            t[b] = g
                                .button(
                                    a.text,
                                    F,
                        ...
                        !1 !== B &&
                            ...
                            (c.inputGroup = p = g.g("input-group").add(L)),
                            (p.offset = 0),
                            c.drawInput("min"),
                            c.drawInput("max")));
                    ...
                    d &&
                        ...
                        "top" === W &&
                        "right" === u.align &&
                        u.y + E.getBBox().height - 12 < (d.y || 0) + d.height &&
                        (U = -40);
                    "left" === u.align
                        ? (S = u.x - f.spacing[3])
                        : "right" === u.align && (S = u.x + U - f.spacing[1]);
                    E.align(
                        {
                            y: u.y,
                    ...
                    !1 !== B &&
                        ((U =
                            ...
                            "top" === W &&
                            "right" === v.align &&
                            v.y - p.getBBox().height - 12 <
                                (d.y || 0) + d.height + f.spacing[0]
                                ? -40
                                : 0),
                        "left" === v.align
                            ? (S = C)
                            : "right" === v.align &&
                              (S = -Math.max(f.axisOffset[1], -U)),
                        p.align(
                            {
                                y: v.y,
                        ...
                        (k =
                            ...
                            p.getBBox().x +
                            2),
                        (d = p.alignOptions.width),
                        (q = E.alignAttr.translateX + E.getBBox().x),
                        (S = E.getBBox().width + 20),
                        (v.align === u.align ||
                            (q + S > k &&
                                k + d > q &&
                                ba < X + p.getBBox().height)) &&
                            p.attr({
                                translateX:
                                    p.alignAttr.translateX +
                                    (f.axisOffset[1] >= -U ? 0 : -U),
                                translateY:
                    ...
                    "bottom" === W &&
                        ((Z =
                            aa &&
                            "bottom" === aa.verticalAlign &&
                            aa.enabled &&
                            !aa.floating
                                ? Z.legendHeight + n(aa.margin, 10)
                                : 0),
                        (a = a + Z - 20),
                        (R = b - a - (m ? 0 : h.y) - 10));
                    if ("top" === W)
                        m && (R = 0),
                            f.titleOffset &&
                                (R = f.titleOffset + f.options.title.margin),
                            (R += f.margin[0] - f.spacing[0] || 0);
                    else if ("middle" === W)
                    ...
                    !1 !== B &&
                        ((c.minInput.style.marginTop =
                            c.group.translateY + "px"),
                        (c.maxInput.style.marginTop =
                            c.group.translateY + "px"));
                    c.rendered = !0;
                }
            },
        ...
        F.prototype.minFromRange = function () {
            ...
            e <= g &&
                ((e = g),
                void 0 === k && (k = l(e, a.count)),
                (this.newMax = Math.min(e + k, this.dataMax)));
            b(f) || (e = void 0);
            return e;
        };
        ...
        u(r.prototype, "render", function (a, b, c) {
            ...
            g &&
                ...
                this.getAxisMargins(),
                g.render(),
                (f = g.options.verticalAlign),
                g.options.floating ||
                    ("bottom" === f
                        ? (this.extraBottomMargin = !0)
                        : "middle" !== f && (this.extraTopMargin = !0)));
            a.call(this, b, c);
        });
        u(r.prototype, "update", function (b, c, e, f) {
            ...
            g &&
                (g.render(),
                (k =
                    (c.rangeSelector && c.rangeSelector.verticalAlign) ||
                    (g.options && g.options.verticalAlign)),
                g.options.floating ||
                    ("bottom" === k
                        ? (this.extraBottomMargin = !0)
                        : "middle" !== k && (this.extraTopMargin = !0)));
            b.call(
                this,
                a.merge(!0, c, {
                    chart: {
                        marginBottom: n(
                            c.chart && c.chart.marginBottom,
                            this.margin.bottom
                        ),
                        spacingBottom: n(
                            c.chart && c.chart.spacingBottom,
                            this.spacing.bottom
                        ),
                    },
                }),
        ...
        r.prototype.callbacks.push(function (a) {
            ...
            var e,
                ...
                k;
            f &&
                ((k = E(a.xAxis[0], "afterSetExtremes", function (a) {
    ...
    (function (a) {
        ...
        a.StockChart = a.stockChart = function (d, e, f) {
            var h = c(d) || d.nodeName,
                ...
                p,
                q = g(
                    l.navigator && l.navigator.enabled,
                    n.navigator.enabled,
                    !0
                ),
                t = q ? { startOnTick: !1, endOnTick: !1 } : null,
                v = { marker: { enabled: !1, radius: 2 } },
                z = { shadow: !1, borderWidth: 0 };
                ...
                (d.horiz
                    ? l(D, function (a) {
                          ...
                          if (x < v || x > v + d.width)
                              p
                                  ? (x = y =
                                        Math.min(Math.max(v, x), v + d.width))
                                  : (b = !0);
        ...
        A(F.prototype, "drawCrosshair", function (a, b, c) {
            ...
            if (
                ...
                k
                    ? ((q = v ? c.plotX + e : b.chartX),
                      (l += d ? 0 : this.height))
                    : ((q = d ? this.width + e : 0),
                      (l = v ? c.plotY + l : b.chartY));
                r ||
                    f.formatter ||
                ...
                n.attr({
                    ...
                    y: l,
                    visibility:
                        b < this.min || b > this.max ? "hidden" : "visible",
                });
                b = n.getBBox();
                if (k) {
                    if ((u && !d) || (!u && d)) l = n.y - b.height;
                } else l = n.y - b.height / 2;
                k
                    ? ((d = e - b.x), (e = e + this.width - b.x))
                    : ((d = "left" === this.labelAlign ? e : 0),
                      (e =
                          "right" === this.labelAlign
                              ? e + this.width
                              : a.chartWidth));
                n.translateX < d && (z = d - n.translateX);
                n.translateX + b.width >= e &&
                    (z = -(n.translateX + b.width - e));
                n.attr({
                    x: q + z,
                    y: l,
        ...
        n.prototype.tooltipFormatter = function (b) {
            b = b.replace(
                ...
                (0 < this.change ? "+" : "") +
                    a.numberFormat(
                        this.change,
                        g(this.series.tooltipOptions.changeDecimals, 2)
                    )
            );
        ...
        A(f.prototype, "render", function (a) {
            (this.chart.is3d && this.chart.is3d()) ||
                ...
                (!this.clipBox && this.animate
                    ? ((this.clipBox = b(this.chart.clipBox)),
        ...
        A(r.prototype, "update", function (a, c) {
            "scrollbar" in c &&
                this.navigator &&
                (b(!0, this.options.scrollbar, c.scrollbar),
